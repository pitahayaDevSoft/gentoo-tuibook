...
Ora si prosegua con [Configurare il programma d'avvio](/wiki/Handbook:SPARC/Installation/Bootloader/it "Handbook:SPARC/Installation/Bootloader/it").

[← Configurare il sistema](/wiki/Handbook:SPARC/Installation/System/it "Previous part") [Home](/wiki/Handbook:SPARC "Handbook:SPARC") [Configurare programma d'avvio →](/wiki/Handbook:SPARC/Installation/Bootloader/it "Next part")