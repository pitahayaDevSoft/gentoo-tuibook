...
[SPARC Handbook](/wiki/Handbook:SPARC "Handbook:SPARC")[Installation](/wiki/Handbook:SPARC/Full/Installation "Handbook:SPARC/Full/Installation")[About the installation](/wiki/Handbook:SPARC/Installation/About/pl "Handbook:SPARC/Installation/About/pl")[Choosing the media](/wiki/Handbook:SPARC/Installation/Media/pl "Handbook:SPARC/Installation/Media/pl")[Configuring the network](/wiki/Handbook:SPARC/Installation/Networking/pl "Handbook:SPARC/Installation/Networking/pl")[Preparing the disks](/wiki/Handbook:SPARC/Installation/Disks/pl "Handbook:SPARC/Installation/Disks/pl")[The stage file](/wiki/Handbook:SPARC/Installation/Stage/pl "Handbook:SPARC/Installation/Stage/pl")Installing base system[Configuring the kernel](/wiki/Handbook:SPARC/Installation/Kernel/pl "Handbook:SPARC/Installation/Kernel/pl")[Configuring the system](/wiki/Handbook:SPARC/Installation/System/pl "Handbook:SPARC/Installation/System/pl")[Installing tools](/wiki/Handbook:SPARC/Installation/Tools/pl "Handbook:SPARC/Installation/Tools/pl")[Configuring the bootloader](/wiki/Handbook:SPARC/Installation/Bootloader/pl "Handbook:SPARC/Installation/Bootloader/pl")[Finalizing](/wiki/Handbook:SPARC/Installation/Finalizing/pl "Handbook:SPARC/Installation/Finalizing/pl")[Working with Gentoo](/wiki/Handbook:SPARC/Full/Working "Handbook:SPARC/Full/Working")[Portage introduction](/wiki/Handbook:SPARC/Working/Portage/pl "Handbook:SPARC/Working/Portage/pl")[USE flags](/wiki/Handbook:SPARC/Working/USE/pl "Handbook:SPARC/Working/USE/pl")[Portage features](/wiki/Handbook:SPARC/Working/Features/pl "Handbook:SPARC/Working/Features/pl")[Initscript system](/wiki/Handbook:SPARC/Working/Initscripts/pl "Handbook:SPARC/Working/Initscripts/pl")[Environment variables](/wiki/Handbook:SPARC/Working/EnvVar/pl "Handbook:SPARC/Working/EnvVar/pl")[Working with Portage](/wiki/Handbook:SPARC/Full/Portage "Handbook:SPARC/Full/Portage")[Files and directories](/wiki/Handbook:SPARC/Portage/Files/pl "Handbook:SPARC/Portage/Files/pl")[Variables](/wiki/Handbook:SPARC/Portage/Variables/pl "Handbook:SPARC/Portage/Variables/pl")[Mixing software branches](/wiki/Handbook:SPARC/Portage/Branches/pl "Handbook:SPARC/Portage/Branches/pl")[Additional tools](/wiki/Handbook:SPARC/Portage/Tools/pl "Handbook:SPARC/Portage/Tools/pl")[Custom package repository](/wiki/Handbook:SPARC/Portage/CustomTree/pl "Handbook:SPARC/Portage/CustomTree/pl")[Advanced features](/wiki/Handbook:SPARC/Portage/Advanced/pl "Handbook:SPARC/Portage/Advanced/pl")[OpenRC network configuration](/wiki/Handbook:SPARC/Full/Networking "Handbook:SPARC/Full/Networking")[Getting started](/wiki/Handbook:SPARC/Networking/Introduction/pl "Handbook:SPARC/Networking/Introduction/pl")[Advanced configuration](/wiki/Handbook:SPARC/Networking/Advanced/pl "Handbook:SPARC/Networking/Advanced/pl")[Modular networking](/wiki/Handbook:SPARC/Networking/Modular/pl "Handbook:SPARC/Networking/Modular/pl")[Wireless](/wiki/Handbook:SPARC/Networking/Wireless/pl "Handbook:SPARC/Networking/Wireless/pl")[Adding functionality](/wiki/Handbook:SPARC/Networking/Extending/pl "Handbook:SPARC/Networking/Extending/pl")[Dynamic management](/wiki/Handbook:SPARC/Networking/Dynamic/pl "Handbook:SPARC/Networking/Dynamic/pl")
...
If the Gentoo installation is interrupted anywhere after this point, it _should_ be possible to 'resume' the installation at this step. There is no need to re-partition the disks again! Simply check the date and time, [mount the root partition](/wiki/Handbook:SPARC/Installation/Disks/pl#Mounting_the_root_partition "Handbook:SPARC/Installation/Disks/pl") and run the steps above starting with [copying the DNS info](/wiki/Handbook:SPARC/Installation/Base/pl#Copy_DNS_info "Handbook:SPARC/Installation/Base/pl") to re-enter the working environment. This is also useful for fixing bootloader issues. More information can be found in the [chroot](/wiki/Chroot "Chroot") article.
...
The repository configuration for a binhost is found in Portage's /etc/portage/binrepos.conf/ directory, which functions similarly to the configuration mentioned in the [Gentoo ebuild repository](/wiki/Handbook:SPARC/Installation/Base/pl#Gentoo_ebuild_repository "Handbook:SPARC/Installation/Base/pl") section.

When defining a binary host, there are two important aspects to consider:

1. The architecture and profile targets within the `sync-uri` value _do_ matter and should align to the respective computer architecture ( **sparc** in this case) and system profile selected in the [Choosing the right profile](/wiki/Handbook:SPARC/Installation/Base/pl#Choosing_the_right_profile "Handbook:SPARC/Installation/Base/pl") section.
2. Selecting a fast, geographically close mirror will generally shorten retrieval time. Review the mirrorselect tool mentioned in the [Optional: Selecting mirrors](/wiki/Handbook:SPARC/Installation/Base/pl#Gentoo_ebuild_repository "Handbook:SPARC/Installation/Base/pl") section or review the [online list of mirrors](https://www.gentoo.org/downloads/mirrors/) where URL values can be discovered.
...
Additional Portage features will be discussed in the [the next chapter](/wiki/Handbook:SPARC/Working/Features/pl#Portage_features "Handbook:SPARC/Working/Features/pl") of the handbook.
...
Readers who added a binary host [above](/wiki/Handbook:SPARC/Installation/Base/pl#Optional:_Adding_a_binary_package_host "Handbook:SPARC/Installation/Base/pl") can add --getbinpkg (or -g) in order to fetch packages from the binary host instead of compiling them:
...
[← Installing the stage file](/wiki/Handbook:SPARC/Installation/Stage "Previous part") [Home](/wiki/Handbook:SPARC "Handbook:SPARC") [Configuring the kernel →](/wiki/Handbook:SPARC/Installation/Kernel "Next part")