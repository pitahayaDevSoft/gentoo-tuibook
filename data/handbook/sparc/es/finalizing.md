...
¿No está seguro de dónde ir desde aquí?. Hay muchos caminos a explorar... Gentoo proporciona a sus usuarios montones de posibilidades, y por lo tanto tiene montones de artículos documentados (y menos también menos documentados) para que sean explorados aquí en el wiki y en otros subdominios relacionados (leer la sección [Gentoo online](/wiki/Handbook:SPARC/Installation/Finalizing/es#Gentoo_online "Handbook:SPARC/Installation/Finalizing/es") abajo).
...
[← Configurar el cargador de arranque](/wiki/Handbook:SPARC/Installation/Bootloader/es "Previous part") [Inicio](/wiki/Handbook:SPARC/es "Handbook:SPARC/es") [→](/wiki/Handbook:SPARC/Working/Portage/es "Next part")