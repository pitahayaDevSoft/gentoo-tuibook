...
- [5Arrancar](#Arrancar)
  - [5.1Arrancar el CD de instalación](#Arrancar_el_CD_de_instalaci.C3.B3n)
...
Antes de continuar con el proceso de instalación, se deben cumplir los requisitos mínimos de hardware para instalar Gentoo exitosamente para la arquitectura del sistema **sparc**.
...
Los archivos de stage 3 se pueden descargar desde releases/sparc/autobuilds/ en cualquiera de los [mirrors oficiales de Gentoo](https://www.gentoo.org/downloads/mirrors/). Las stages se actualizan con frecuencia y, por lo tanto, no se incluyen en las imágenes live oficiales.
...
3. Seleccione el directorio para la arquitectura adecuada (por ejemplo **sparc/**).
...
Inserte el CD de instalación de Gentoo en la unidad de CD-ROM e inicie el sistema. Durante el inicio, pulse `Stop+A` para entrar en OpenBootPROM (OBP). Una vez en OBP, inicie desde el CD-ROM:

`ok` `boot cdrom`

Se inicia entonces el gestor de arranque SILO (en el CD de isntalación). Pulse `Intro` para obtener más ayuda. Teclee _gentoo_ y pulse `Intro` continuar con el arranque del sistema:

`boot:` `gentoo`

Una vez se haya iniciado el CD de instalación, se mostrará un símbolo de espera de órdenes de
root ("#") en la consola actual. También estará disponible un símbolo de espera de órdenes de root en la consola serie (ttyS0).
...
`user $` `links https://wiki.gentoo.org/wiki/Handbook:SPARC/es`
...
Para poder utilizar sshd, la red debe funcionar correctamente. Continúe con el capítulo sobre [Configuración de la red](/wiki/Handbook:SPARC/Installation/Networking/es "Handbook:SPARC/Installation/Networking/es")

[← Acerca de la instalación](/wiki/Handbook:SPARC/Installation/About/es "Previous part") [Inicio](/wiki/Handbook:SPARC/es "Handbook:SPARC/es") [Configurando la red →](/wiki/Handbook:SPARC/Installation/Networking/es "Next part")