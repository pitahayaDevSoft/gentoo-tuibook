...
_[Distribution Kernels](/wiki/Project:Distribution_Kernel "Project:Distribution Kernel")_, such as [sys-kernel/gentoo-kernel](https://packages.gentoo.org/packages/sys-kernel/gentoo-kernel) and [sys-kernel/gentoo-kernel-bin](https://packages.gentoo.org/packages/sys-kernel/gentoo-kernel-bin), by default, expect to be installed alongside an [initramfs](/wiki/Handbook:SPARC/Installation/Kernel#Initramfs.2Fes "Handbook:SPARC/Installation/Kernel"). Before running emerge to install the kernel users should ensure that [sys-kernel/installkernel](https://packages.gentoo.org/packages/sys-kernel/installkernel) has been configured to utilize an initramfs generator (for example [Dracut](/wiki/Dracut "Dracut")) as described in the [installkernel section](/wiki/Handbook:SPARC/Installation/Kernel#Initramfs.2Fes "Handbook:SPARC/Installation/Kernel").
...
After installing the Distribution Kernel successfully, it is now time to proceed to the next section: [Configuring the system](/wiki/Handbook:SPARC/Installation/System/es "Handbook:SPARC/Installation/System/es").

### Alternativa: Configuración manual

### Instalar las fuentes del núcleo

Al instalar y compilar el núcleo para sistemas basados en sparc, Gentoo recomienda el paquete [sys-kernel/gentoo-sources](https://packages.gentoo.org/packages/sys-kernel/gentoo-sources).
...
For now please follow installing [sys-kernel/gentoo-kernel-bin](https://packages.gentoo.org/packages/sys-kernel/gentoo-kernel-bin) via [Distribution\_kernels](/wiki/Handbook:SPARC/Installation/Kernel#Distribution_kernels.2Fes "Handbook:SPARC/Installation/Kernel").
...
Now it's time to decide if modules signing is required in the steps listed in [here](/wiki/Handbook:SPARC/Installation/Kernel#Optional:_Signed_kernel_modules_2.2Fes "Handbook:SPARC/Installation/Kernel")

If not, proceed to building described [here](/wiki/Handbook:SPARC/Installation/Kernel#Compiling_and_installing.2Fes "Handbook:SPARC/Installation/Kernel")
...
[Handbook:SPARC/Blocks/Kernel/es](/index.php?title=Handbook:SPARC/Blocks/Kernel/es&action=edit&redlink=1 "Handbook:SPARC/Blocks/Kernel/es (page does not exist)")

Continúe la instalación con [Configuring the system](/wiki/Handbook:SPARC/Installation/System/es "Handbook:SPARC/Installation/System/es").

[← Instalar el sistema base](/wiki/Handbook:SPARC/Installation/Base/es "Previous part") [Inicio](/wiki/Handbook:SPARC/es "Handbook:SPARC/es") [Configurar el sistema →](/wiki/Handbook:SPARC/Installation/System/es "Next part")