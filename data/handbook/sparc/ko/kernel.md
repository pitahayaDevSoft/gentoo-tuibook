...
Installing certain firmware packages often requires accepting the associated firmware licenses. If necessary, visit the [license handling section](/wiki/Handbook:SPARC/Working/Portage/ko#Licenses "Handbook:SPARC/Working/Portage/ko") of the Handbook for help on accepting licenses.
...
Kernel installation tasks such as copying the kernel image to /boot or the [EFI System Partition](/wiki/EFI_System_Partition "EFI System Partition"), generating an [initramfs](/wiki/Initramfs "Initramfs") and/or [Unified Kernel Image](/wiki/Unified_Kernel_Image "Unified Kernel Image"), updating bootloader configuration, can be automated with [installkernel](/wiki/Installkernel "Installkernel"). Users may wish to configure and install [sys-kernel/installkernel](https://packages.gentoo.org/packages/sys-kernel/installkernel) before proceeding. See the [Kernel installation section below](/wiki/Handbook:SPARC/Installation/Kernel#Kernel_installation.2Fko "Handbook:SPARC/Installation/Kernel") for more more information.
...
Now it's time to decide if modules signing is required in the steps listed in [here](/wiki/Handbook:SPARC/Installation/Kernel#Optional:_Signed_kernel_modules_2.2Fko "Handbook:SPARC/Installation/Kernel")

If not, proceed to building described [here](/wiki/Handbook:SPARC/Installation/Kernel#Compiling_and_installing.2Fko "Handbook:SPARC/Installation/Kernel")
...
[시스템 설정](/wiki/Handbook:SPARC/Installation/System/ko "Handbook:SPARC/Installation/System/ko") 으로 설치 과정을 계속 진행하십시오.

[← 젠투 베이스 시스템 설치](/wiki/Handbook:SPARC/Installation/Base/ko "이전 내용") [처음](/wiki/Handbook:SPARC/ko "Handbook:SPARC/ko") [시스템 설정 →](/wiki/Handbook:SPARC/Installation/System/ko "다음 내용")