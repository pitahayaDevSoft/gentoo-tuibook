...
Most folytassa a [Bootloader beállítása](/wiki/Handbook:SPARC/Installation/Bootloader/hu "Handbook:SPARC/Installation/Bootloader/hu") részével.

[← Rendszer beállítása](/wiki/Handbook:SPARC/Installation/System/hu "Previous part") [Kezdőlap](/wiki/Handbook:SPARC/hu "Handbook:SPARC/hu") [Bootloader beállítása →](/wiki/Handbook:SPARC/Installation/Bootloader/hu "Next part")