...
- [5Démarrage](#D.C3.A9marrage)
  - [5.1Démarrer le CD d'installation](#D.C3.A9marrer_le_CD_d.27installation)
...
L’archive _stage3_ peut être téléchargée depuis releases/sparc/autobuilds/ sur l’un des [miroirs Gentoo officiels](https://www.gentoo.org/downloads/mirrors/). Ces archives sont mises à jour fréquemment et ne sont pas incluses dans les images d’installation officielles.
...
3. Sélectionner le répertoire correspondant à l’architecture souhaitée (tel que **sparc/**).
...
CODE **Liste d'exemple des fichiers téléchargeables dans releases/sparc/autobuilds/current-iso/**
...
`user $` `links https://wiki.gentoo.org/wiki/Handbook:SPARC/fr`
...
Pour être en mesure d'utiliser sshd, le réseau a besoin de fonctionner correctement. Continuez l’installation avec le chapitre [Configurer le réseau](/wiki/Handbook:SPARC/Installation/Networking/fr "Handbook:SPARC/Installation/Networking/fr").

[← À propos de l’installation](/wiki/Handbook:SPARC/Installation/About/fr "Previous part") [Accueil](/wiki/Handbook:SPARC/fr "Handbook:SPARC/fr") [Configurer le réseau →](/wiki/Handbook:SPARC/Installation/Networking/fr "Next part")