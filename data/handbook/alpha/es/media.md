...
CÓDIGO **Example list of downloadable files at releases/amd64/autobuilds/current-install-amd64-minimal/**
...
A more elaborate set of instructions can be found in [CD/DVD/BD\_writing#Image\_writing](/wiki/CD/DVD/BD_writing#Image_writing.2Fes "CD/DVD/BD writing").
...
To be able to use sshd, the network needs to function properly. Continue with the chapter on [Configuring the network](/wiki/Handbook:Alpha/Installation/Networking/es "Handbook:Alpha/Installation/Networking/es").
