...
次は [ブートローダーの設定](/wiki/Handbook:Alpha/Installation/Bootloader/ja "Handbook:Alpha/Installation/Bootloader/ja") です。

[← システムの設定](/wiki/Handbook:Alpha/Installation/System/ja "Previous part") [Home](/wiki/Handbook:Alpha/ja "Handbook:Alpha/ja") [ブートローダーの設定 →](/wiki/Handbook:Alpha/Installation/Bootloader/ja "Next part")