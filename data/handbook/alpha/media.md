...
### Booting the installation CD\[ [edit](/index.php?title=Handbook:Alpha/Blocks/Booting&action=edit&section=T-1 "Edit section: ")\]
...
To be able to use sshd, the network needs to function properly. Continue with the chapter on [Configuring the network](/wiki/Handbook:Alpha/Installation/Networking "Handbook:Alpha/Installation/Networking").
