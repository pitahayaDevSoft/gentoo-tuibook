...
Sur la liste des miroirs, choisissez-en un à proximité. En général les miroirs HTTP suffisent, mais d’autres protocoles sont également disponibles. Naviguez vers le répertoire releases/alpha/autobuilds/. Ici, toutes les archives _stage_ disponibles sont affichées (elles peuvent être stockées dans des sous-répertoires nommés après les différents types d’architectures). Sélectionnez-en une et appuyez sur la touche `d` pour la télécharger.

Une fois le téléchargement de l'archive terminé, il es possible d’en vérifier l’intégrité et d’en valider son contenu. Les intéressés peuvent passer à la [section suivante](/wiki/Handbook:Alpha/Installation/Stage/fr#Verifying_and_validating "Handbook:Alpha/Installation/Stage/fr").

Ceux qui ne sont pas intéressés peuvent fermer le navigateur en ligne de commande en appuyant sur la touche `q` et peuvent aller directement à la section [Extraction de l’archive tar](/wiki/Handbook:Alpha/Installation/Stage/fr#Unpacking_the_stage_file "Handbook:Alpha/Installation/Stage/fr").
...
`root #` `gpg --verify stage3-alpha-<release>-<init>.tar.xz.DIGESTS
`
...
Maintenant que l’archive est extraite, continuez avec la [Configuration des options de compilation](/wiki/Handbook:Alpha/Installation/Stage/fr#Configuring_compile_options "Handbook:Alpha/Installation/Stage/fr").
...
[← Préparer les disques](/wiki/Handbook:Alpha/Installation/Disks/fr "Previous part") [Home](/wiki/Handbook:Alpha "Handbook:Alpha") [Installation du système de base →](/wiki/Handbook:Alpha/Installation/Base/fr "Next part")