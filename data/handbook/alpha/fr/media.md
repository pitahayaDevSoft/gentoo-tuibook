...
L’archive _stage3_ peut être téléchargée depuis releases/alpha/autobuilds/ sur l’un des [miroirs Gentoo officiels](https://www.gentoo.org/downloads/mirrors/). Ces archives sont mises à jour fréquemment et ne sont pas incluses dans les images d’installation officielles.
...
3. Sélectionner le répertoire correspondant à l’architecture souhaitée (tel que **alpha/**).
...
Pour être en mesure d'utiliser sshd, le réseau a besoin de fonctionner correctement. Continuez l’installation avec le chapitre [Configurer le réseau](/wiki/Handbook:Alpha/Installation/Networking/fr "Handbook:Alpha/Installation/Networking/fr").

[← À propos de l’installation](/wiki/Handbook:Alpha/Installation/About/fr "Previous part") [Accueil](/wiki/Handbook:Alpha/fr "Handbook:Alpha/fr") [Configurer le réseau →](/wiki/Handbook:Alpha/Installation/Networking/fr "Next part")