...
Nachdem Sie das Stage Tar-Archiv erfolgreich heruntergeladen haben, können Sie die Integrität des Tar-Archivs verifizieren und den Inhalt validieren. Wie das geht, steht im [folgenden Abschnitt](/wiki/Handbook:Alpha/Installation/Stage/de#Verifying_and_validating "Handbook:Alpha/Installation/Stage/de").

Wenn Sie kein Interesse an einer Überprüfung und Validierung des Stage Tar-Archivs haben, können Sie jetzt `q` drücken, um den Browser zu beenden. Springen Sie danach zu dem Abschnitt [Stage Tar-Archiv entpacken](/wiki/Handbook:Alpha/Installation/Stage/de#Unpacking_the_stage_tarball "Handbook:Alpha/Installation/Stage/de").
...
For all non-official live images which offer gpg and wget in the live environment, refer to the earlier [Verifying the downloaded files](/wiki/Handbook:Alpha/Installation/Media/de#Verifying_the_downloaded_files "Handbook:Alpha/Installation/Media/de") section.
...
Nachdem nun das Stage Tar-Archiv ausgepackt ist, geht es weiter mit dem Schritt: [Compiler-Optionen konfigurieren](/wiki/Handbook:Alpha/Installation/Stage/de#Configuring_compile_options "Handbook:Alpha/Installation/Stage/de").
...
[← Vorbereiten der Festplatte(n)](/wiki/Handbook:Alpha/Installation/Disks/de "Previous part") [Anfang](/wiki/Handbook:Alpha/de "Handbook:Alpha/de") [Installation des Basissystems →](/wiki/Handbook:Alpha/Installation/Base/de "Next part")