...
For all non-official live images which offer gpg and wget in the live environment, refer to the earlier [Verifying the downloaded files](/wiki/Handbook:Alpha/Installation/Media/cs#Verifying_the_downloaded_files "Handbook:Alpha/Installation/Media/cs") section.
...
[← Příprava disků](/wiki/Handbook:Alpha/Installation/Disks/cs "Previous part") [Home](/wiki/Handbook:Alpha "Handbook:Alpha") [Instalace základního systému →](/wiki/Handbook:Alpha/Installation/Base/cs "Next part")