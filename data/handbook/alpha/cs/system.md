...
V našem příkladu dělení oddílů pro architekturu alpha, bývá /boot/ obvykle oddílem /dev/sda1 se souborovým systémem ext2. V průběhu zavádění systému musí být zkontrolován, takže bychom měli zapsat:
...
For systems running OpenRC, a more detailed reference for network setup is available in the [advanced network configuration](/wiki/Handbook:Alpha/Networking/Introduction/cs "Handbook:Alpha/Networking/Introduction/cs") section, which is covered near the end of the handbook. Systems with more specific network needs may need to skip ahead, then return here to continue with the rest of the installation.
...
[← Konfigurace jádra](/wiki/Handbook:Alpha/Installation/Kernel/cs "Previous part") [Home](/wiki/Handbook:Alpha/cs "Handbook:Alpha/cs") [Instalace nástrojů →](/wiki/Handbook:Alpha/Installation/Tools/cs "Next part")