...
Installing certain firmware packages often requires accepting the associated firmware licenses. If necessary, visit the [license handling section](/wiki/Handbook:Alpha/Working/Portage/ko#Licenses "Handbook:Alpha/Working/Portage/ko") of the Handbook for help on accepting licenses.
...
Now it's time to decide if modules signing is required in the steps listed in [here](/wiki/Handbook:Alpha/Installation/Kernel#Optional:_Signed_kernel_modules_2.2Fko "Handbook:Alpha/Installation/Kernel")

If not, proceed to building described [here](/wiki/Handbook:Alpha/Installation/Kernel#Compiling_and_installing.2Fko "Handbook:Alpha/Installation/Kernel")
...
커널 컴파일이 끝나면 /boot/에 커널 이미지를 복사하십시오. 최근 커널은 vmlinux.gz대신 vmlinux를 만듭니다. 커널 이미지를 복사할 때 이 점을 기억해두십시오.

`root #` `cp arch/alpha/boot/vmlinux.gz /boot/`

[시스템 설정](/wiki/Handbook:Alpha/Installation/System/ko "Handbook:Alpha/Installation/System/ko") 으로 설치 과정을 계속 진행하십시오.

[← 젠투 베이스 시스템 설치](/wiki/Handbook:Alpha/Installation/Base/ko "이전 내용") [처음](/wiki/Handbook:Alpha/ko "Handbook:Alpha/ko") [시스템 설정 →](/wiki/Handbook:Alpha/Installation/System/ko "다음 내용")