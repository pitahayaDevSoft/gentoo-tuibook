...
Most folytassa a [Bootloader beállítása](/wiki/Handbook:Alpha/Installation/Bootloader/hu "Handbook:Alpha/Installation/Bootloader/hu") részével.

[← Rendszer beállítása](/wiki/Handbook:Alpha/Installation/System/hu "Previous part") [Kezdőlap](/wiki/Handbook:Alpha/hu "Handbook:Alpha/hu") [Bootloader beállítása →](/wiki/Handbook:Alpha/Installation/Bootloader/hu "Next part")