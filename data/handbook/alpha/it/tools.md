...
Ora si prosegua con [Configurare il programma d'avvio](/wiki/Handbook:Alpha/Installation/Bootloader/it "Handbook:Alpha/Installation/Bootloader/it").

[← Configurare il sistema](/wiki/Handbook:Alpha/Installation/System/it "Previous part") [Home](/wiki/Handbook:Alpha "Handbook:Alpha") [Configurare programma d'avvio →](/wiki/Handbook:Alpha/Installation/Bootloader/it "Next part")