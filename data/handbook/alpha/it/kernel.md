...
Installare certi pacchetti firmware spesso richiede l'accettazione di licenze associate al firmware. Se necessario, visitare la [sezione di gestione delle licenze](/wiki/Handbook:Alpha/Working/Portage/it#Licenses "Handbook:Alpha/Working/Portage/it") del manuale per aiuto sull'accettazione delle licenze.
...
Ora è tempo di decidere se la firma dei moduli è necessaria nei passaggi elencati [qui](/wiki/Handbook:Alpha/Installation/Kernel#Optional:_Signed_kernel_modules_2.2Fit "Handbook:Alpha/Installation/Kernel").

Altrimenti, proseguire con la compilazione come descritta [qui](/wiki/Handbook:Alpha/Installation/Kernel#Compiling_and_installing.2Fit "Handbook:Alpha/Installation/Kernel").
...
[Handbook:Alpha/Blocks/Kernel/it](/index.php?title=Handbook:Alpha/Blocks/Kernel/it&action=edit&redlink=1 "Handbook:Alpha/Blocks/Kernel/it (page does not exist)")

Continuare l'installazione con [configurare il sistema](/wiki/Handbook:Alpha/Installation/System/it "Handbook:Alpha/Installation/System/it").

[← Installare il sistema base](/wiki/Handbook:Alpha/Installation/Base/it "Previous part") [Home](/wiki/Handbook:Alpha "Handbook:Alpha") [Configurare il sistema →](/wiki/Handbook:Alpha/Installation/System/it "Next part")