...
Ora si prosegua con [Configurare il programma d'avvio](/wiki/Handbook:PPC/Installation/Bootloader/it "Handbook:PPC/Installation/Bootloader/it").

[← Configurare il sistema](/wiki/Handbook:PPC/Installation/System/it "Previous part") [Home](/wiki/Handbook:PPC "Handbook:PPC") [Configurare programma d'avvio →](/wiki/Handbook:PPC/Installation/Bootloader/it "Next part")