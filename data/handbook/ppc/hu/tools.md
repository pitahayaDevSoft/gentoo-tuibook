...
Most folytassa a [Bootloader beállítása](/wiki/Handbook:PPC/Installation/Bootloader/hu "Handbook:PPC/Installation/Bootloader/hu") részével.

[← Rendszer beállítása](/wiki/Handbook:PPC/Installation/System/hu "Previous part") [Kezdőlap](/wiki/Handbook:PPC/hu "Handbook:PPC/hu") [Bootloader beállítása →](/wiki/Handbook:PPC/Installation/Bootloader/hu "Next part")