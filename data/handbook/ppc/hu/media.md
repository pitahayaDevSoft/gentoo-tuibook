...
- [5Rendszerindítás (bootolás)](#Rendszerind.C3.ADt.C3.A1s_.28bootol.C3.A1s.29)
  - [5.1Alapértelmezett: Telepítő CD bootolása yaboot segítségével](#Alap.C3.A9rtelmezett:_Telep.C3.ADt.C5.91_CD_bootol.C3.A1sa_yaboot_seg.C3.ADts.C3.A9g.C3.A9vel)
  - [5.2Alternatíva: Az telepítő CD indítása Pegasos rendszeren](#Alternat.C3.ADva:_Az_telep.C3.ADt.C5.91_CD_ind.C3.ADt.C3.A1sa_Pegasos_rendszeren)
  - [5.3Alternatíva: Az telepítő CD indítása BootX használatával](#Alternat.C3.ADva:_Az_telep.C3.ADt.C5.91_CD_ind.C3.ADt.C3.A1sa_BootX_haszn.C3.A1lat.C3.A1val)
  - [5.4Billentyűzetkiosztás beállítása](#Billenty.C5.B1zetkioszt.C3.A1s_be.C3.A1ll.C3.ADt.C3.A1sa)
  - [5.5LiveGUI root access](#LiveGUI_root_access)
  - [5.6Extra hardverbeállítás](#Extra_hardverbe.C3.A1ll.C3.ADt.C3.A1s)
  - [5.7Opcionális: Felhasználói fiókok](#Opcion.C3.A1lis:_Felhaszn.C3.A1l.C3.B3i_fi.C3.B3kok)
  - [5.8Opcionális: Dokumentáció megtekintése telepítés közben](#Opcion.C3.A1lis:_Dokument.C3.A1ci.C3.B3_megtekint.C3.A9se_telep.C3.ADt.C3.A9s_k.C3.B6zben)
    - [5.8.1TTY eszközök](#TTY_eszk.C3.B6z.C3.B6k)
    - [5.8.2GNU screen parancs](#GNU_screen_parancs)
  - [5.9Opcionális: Az SSH szolgáltatás elindítása](#Opcion.C3.A1lis:_Az_SSH_szolg.C3.A1ltat.C3.A1s_elind.C3.ADt.C3.A1sa)

## Hardverkövetelmények

Mielőtt folytatná a telepítést, az Ön számítógépének teljesítenie kell a minimális hardverkövetelményeket a Gentoo **ppc** rendszerarchitektúrára való sikeres telepítés érdekében.
...
Az úgynevezett stage 3 (3. fokozat) tar fájlok letölthetőek az internetről a releases/ppc/autobuilds/ oldalról bármelyik [hivatalos Gentoo tükörszerverről](https://www.gentoo.org/downloads/mirrors/). A stage fájlokat gyakran frissítik, ezért azok nincsenek benne a hivatalos Live ISO-képfájlokban.
...
`user $` `gpg --verify install-ppc-minimal-20240107T170309Z.iso.asc`
...
Boot opció
Leírás
`video`Ez az opció az alábbi gyártóspecifikus címkék egyikét használja: nvidiafb, radeonfb, rivafb, atyfb, aty128 vagy ofonly. Kövesse ezt a címkét a használandó felbontás, frissítési arány és színmélység megadásával. Például a `video=radeonfb:1280x1024@75-32` az ATI Radeon képkocka pufferét választja egy 1280x1024-es felbontásban, 75 Hz-es frissítési gyakorisággal és 32 bites színmélységgel. Ha bizonytalan abban, hogy mit válasszon, és az alapértelmezett nem működik, akkor a `video=ofonly` szinte biztosan működni fog.
`nol3`Letiltja a 3. szintű gyorsítótárat néhány PowerBook esetében (legalább a 17"-es modellnél szükséges).
`dofirewire`Engedélyezi az IEEE1394 (FireWire) eszközök, például külső merevlemezek támogatását.
`dopcmcia`Ahhoz, hogy PCMCIA eszközöket használhasson a telepítés során (például PCMCIA hálózati kártyákat), ezt az opciót engedélyezni kell.
`dosshd`Elindítja az SSH szolgáltatást. Hasznos a felügyelet nélküli telepítésekhez.
`passwd=foo`Beállítja a `=` utáni értéket rendszergazdai jelszóként. Használja a `dosshd`-val távoli telepítésekhez.
...
A fenti yaboot szakaszban szereplő kernelparaméterek itt is alkalmazhatók. Adja hozzá bármelyik opciót a fent megadott kernelargumentumokhoz.
...
Az sshd szolgáltatás használatához a hálózatnak megfelelően kell működnie. Folytassa a [Hálózat beállítása](/wiki/Handbook:PPC/Installation/Networking/hu "Handbook:PPC/Installation/Networking/hu") című fejezettel.

[← A telepítésről](/wiki/Handbook:PPC/Installation/About/hu "Previous part") [Kezdőlap](/wiki/Handbook:PPC/hu "Handbook:PPC/hu") [Hálózat beállítása →](/wiki/Handbook:PPC/Installation/Networking/hu "Next part")