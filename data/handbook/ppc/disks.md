...
### Partitions\[ [edit](/index.php?title=Handbook:PPC/Blocks/Disks&action=edit&section=T-1 "Edit section: ")\]
...
### Apple New World\[ [edit](/index.php?title=Handbook:PPC/Blocks/Disks&action=edit&section=T-2 "Edit section: ")\]
...
### Apple Old World\[ [edit](/index.php?title=Handbook:PPC/Blocks/Disks&action=edit&section=T-3 "Edit section: ")\]
...
### Pegasos\[ [edit](/index.php?title=Handbook:PPC/Blocks/Disks&action=edit&section=T-4 "Edit section: ")\]
...
### IBM PReP (RS/6000)\[ [edit](/index.php?title=Handbook:PPC/Blocks/Disks&action=edit&section=T-5 "Edit section: ")\]
...
## Using mac-fdisk (Apple)\[ [edit](/index.php?title=Handbook:PPC/Blocks/Disks&action=edit&section=T-6 "Edit section: ")\]
...
## Using parted (Pegasos and RS/6000)\[ [edit](/index.php?title=Handbook:PPC/Blocks/Disks&action=edit&section=T-7 "Edit section: ")\]
...
Now that the partitions have been created, it is time to place a filesystem on them. In the next section the various file systems that Linux supports are described. Readers that already know which filesystem to use can continue with [Applying a filesystem to a partition](/wiki/Handbook:PPC/Installation/Disks#Applying_a_filesystem_to_a_partition "Handbook:PPC/Installation/Disks"). The others should read on to learn about the available filesystems...
...
Later in the instructions, the proc filesystem (a virtual interface with the kernel) as well as other kernel pseudo-filesystems will be mounted. But first [the Gentoo stage file](/wiki/Handbook:PPC/Installation/Stage "Handbook:PPC/Installation/Stage") must be extracted.
