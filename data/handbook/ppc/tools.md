...
Now continue with [Configuring the bootloader](/wiki/Handbook:PPC/Installation/Bootloader "Handbook:PPC/Installation/Bootloader").

[← Configuring the system](/wiki/Handbook:PPC/Installation/System "Previous part") [Home](/wiki/Handbook:PPC "Handbook:PPC") [Configuring the bootloader →](/wiki/Handbook:PPC/Installation/Bootloader "Next part")