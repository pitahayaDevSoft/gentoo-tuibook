...
Ahora continúe con [Configurar el cargador de arranque](/wiki/Handbook:PPC/Installation/Bootloader/es "Handbook:PPC/Installation/Bootloader/es").

[← Configurar el sistema](/wiki/Handbook:PPC/Installation/System/es "Previous part") [Inicio](/wiki/Handbook:PPC/es "Handbook:PPC/es") [Configurar el cargador de arranque →](/wiki/Handbook:PPC/Installation/Bootloader/es "Next part")