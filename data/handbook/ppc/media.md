...
### Default: Booting the installation CD with yaboot\[ [edit](/index.php?title=Handbook:PPC/Blocks/Booting&action=edit&section=T-1 "Edit section: ")\]
...
### Alternative: Booting the installation CD on a Pegasos system\[ [edit](/index.php?title=Handbook:PPC/Blocks/Booting&action=edit&section=T-2 "Edit section: ")\]
...
### Alternative: Booting the installation CD with BootX\[ [edit](/index.php?title=Handbook:PPC/Blocks/Booting&action=edit&section=T-3 "Edit section: ")\]
...
### Setting the keyboard map\[ [edit](/index.php?title=Handbook:PPC/Blocks/Booting&action=edit&section=T-4 "Edit section: ")\]
...
To be able to use sshd, the network needs to function properly. Continue with the chapter on [Configuring the network](/wiki/Handbook:PPC/Installation/Networking "Handbook:PPC/Installation/Networking").
