...
次は [ブートローダーの設定](/wiki/Handbook:PPC/Installation/Bootloader/ja "Handbook:PPC/Installation/Bootloader/ja") です。

[← システムの設定](/wiki/Handbook:PPC/Installation/System/ja "Previous part") [Home](/wiki/Handbook:PPC/ja "Handbook:PPC/ja") [ブートローダーの設定 →](/wiki/Handbook:PPC/Installation/Bootloader/ja "Next part")