...
Readers should definitely take a look at the next part of the handbook entitled [Working with Gentoo](/wiki/Handbook:PPC/Working/Portage/pl "Handbook:PPC/Working/Portage/pl") which explains how to keep the software up to date, install additional software packages, details on USE flags, the OpenRC init system, and various other informative topics relating to managing a Gentoo system post-installation.
...
[← Configuring the bootloader](/wiki/Handbook:PPC/Installation/Bootloader "Previous part") [Home](/wiki/Handbook:PPC "Handbook:PPC") [→](/wiki/Handbook:PPC/Working/Portage "Next part")