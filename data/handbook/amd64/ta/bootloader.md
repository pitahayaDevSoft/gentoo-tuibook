...
- [4மாற்றுவழி 2: efibootmgr](#.E0.AE.AE.E0.AE.BE.E0.AE.B1.E0.AF.8D.E0.AE.B1.E0.AF.81.E0.AE.B5.E0.AE.B4.E0.AE.BF_2:_efibootmgr)
  - [4.1Unified Kernel Image](#Unified_Kernel_Image)
- [5Other Alternatives](#Other_Alternatives)
- [6முறைமையை மறுஇயக்குதல்](#.E0.AE.AE.E0.AF.81.E0.AE.B1.E0.AF.88.E0.AE.AE.E0.AF.88.E0.AE.AF.E0.AF.88_.E0.AE.AE.E0.AE.B1.E0.AF.81.E0.AE.87.E0.AE.AF.E0.AE.95.E0.AF.8D.E0.AE.95.E0.AF.81.E0.AE.A4.E0.AE.B2.E0.AF.8D)
...
**amd64** கட்டமைப்பிற்கு, BIOS அடிப்படையிலான முறைமைகளுக்கு [GRUB2](#.E0.AE.AE.E0.AF.81.E0.AE.A9.E0.AF.8D.E0.AE.A9.E0.AE.BF.E0.AE.B0.E0.AF.81.E0.AE.AA.E0.AF.8D.E0.AE.AA.E0.AF.81:_GRUB2) அல்லது [LILO](#.E0.AE.AE.E0.AE.BE.E0.AE.B1.E0.AF.8D.E0.AE.B1.E0.AF.81.E0.AE.B5.E0.AE.B4.E0.AE.BF_1:LILO) வையும், UEFI அடிப்படையிலான முறைமைகளுக்கு [GRUB2](#.E0.AE.AE.E0.AF.81.E0.AE.A9.E0.AF.8D.E0.AE.A9.E0.AE.BF.E0.AE.B0.E0.AF.81.E0.AE.AA.E0.AF.8D.E0.AE.AA.E0.AF.81:_GRUB2) அல்லது [efibootmgr](#.E0.AE.AE.E0.AE.BE.E0.AE.B1.E0.AF.8D.E0.AE.B1.E0.AF.81.E0.AE.B5.E0.AE.B4.E0.AE.BF_2:_efibootmgr) வையும் எவ்வாறு உள்ளமைப்பது என நாங்கள் ஆவணப்படுத்தியுள்ளோம்.

கையேட்டின் இந்த பிரிவில், துவக்க ஏற்றித் தொகுப்பை _emerge செய்தல்_ ற்கும், துவக்க ஏற்றியை முறைமை வட்டில் _install செய்தல்_ ற்கும் உள்ள வேறுபாடு விரித்துரைக்கப்பட்டுள்ளது. இங்கு _emerge செய்தல்_ என்பது ஒரு மென்பொருள் தொகுப்பை [Portage](/wiki/Portage "Portage") இடம் கேட்டு முறைமைக்குக் கிடைக்கும்படி செய்வதாகப் பொருள் கொள்ளப்படும். மேலும், _install செய்தல்_ என்பது துவக்க ஏற்றி, கோப்புகளை நகலெடுப்பது அல்லது முறைமையின் வட்டு இயக்ககத்தில் உள்ள பொருத்தமான பிரிவுகளில் மாற்றங்களைச் செய்வது மூலம் துவக்க ஏற்றி _செயல்படுத்தப்பட்டு அடுத்த திறன் சுழலில் வேளை செய்ய ஆயத்தமான_ நிலையில் வைப்பதைக் குறிக்கிறது.

## முன்னிருப்பு: GRUB2

இயல்பாக, பெரும்பாலான ஜென்டூ முறைமைகள் [GRUB மரபுவழி](/wiki/GRUB_Legacy "GRUB Legacy") யின் நேரடி பின்வருநரான [GRUB](/wiki/GRUB "GRUB") ஐ சார்ந்துள்ளது ([sys-boot/grub](https://packages.gentoo.org/packages/sys-boot/grub) தொகுப்பில் காணப்படும்). கூடுதல் உள்ளமைவுகள் எதுவும் இல்லாமல் GRUB2 ஆனது பழைய BIOS ("pc") முறைமைகளை ஆதரிக்கிறது. கட்டுதல் நேரத்திற்கு முன் தேவைப்படும் சிறு அளவிலான உள்ளமைவுகள் மூலம், ஆறிற்கும் அதிகமான கூடுதல் இயங்குதளங்களை GRUB2 ஆதரிக்கும். மேலும் தகவல்களுக்கு, [GRUB2](/wiki/GRUB2 "GRUB2") கட்டுரையில் உள்ள [முன் தேவை பிரிவை](/wiki/GRUB2#Prerequisites "GRUB2") காணவும்.
...
UEFI பயனர்களுக்கான குறிப்பு: மேலுள்ள கட்டளையை இயக்குவது செயல்படுத்தப்பட்டுள்ள GRUB\_PLATFORMS மதிப்புகளை emerge செய்வதற்கு முன் வெளியிடும். UEFI திறனுடைய முறைமைகளைப் பயன்படுத்தும்போது, `GRUB_PLATFORMS="efi-64"` என்பது செயல்படுத்தப்பட்டுள்ளதைப் பயனர்கள் உறுதிசெய்ய வேண்டும். அவ்வாறு இல்லையென்றால், GRUB2 வை emerge செய்வதற்கு _முன்_/etc/portage/make.conf கோப்பில் `GRUB_PLATFORMS="efi-64"` என்பதைச் சேர்க்க வேண்டும். இதன்மூலம் தொகுப்பு EFI செயல்பாட்டுடன் உருவாக்கப்படும்.
...
grub-install ஐ இயக்குவதற்கு _முன்_ EFI முறைமை பகிர்வு ஏற்றப்பட்டுள்ளதா என்பதை உறுதிசெய்து கொள்ளவும். ஏனென்றால் grub-install ஆனது GRUB EFI கோப்பை (grubx64.efi) _எந்தவொரு_ அடையாளத்தையும் _காட்டாமல்_ தவறான அடைவில் நிறுவி விட வாய்ப்புள்ளது.

For UEFI systems:

`root #` `grub-install --target=x86_64-efi --efi-directory=/boot`

Upon successful installation, the output should match the output of the previous command. If the output does not match exactly, then proceed to [Debugging GRUB](/wiki/Handbook:AMD64/Blocks/Bootloader/ta#Debugging_GRUB "Handbook:AMD64/Blocks/Bootloader/ta"), otherwise jump to the [Configure step](/wiki/Handbook:AMD64/Blocks/Bootloader/ta#GRUB_Configure "Handbook:AMD64/Blocks/Bootloader/ta").
...
How to configure the UEFI firmware to accept custom keys depends on the firmware vendor, which is beyond the scope of the handbook. Below is shown how to setup shim instead. Here it is assumed that the user has already followed the instructions in the previous sections to generate a signing key and to configure portage to use it. If this is not the case please return first to the [Kernel installation](/wiki/Handbook:AMD64/Installation/Kernel/ta "Handbook:AMD64/Installation/Kernel/ta") section.

The package [sys-boot/grub](https://packages.gentoo.org/packages/sys-boot/grub) installs a prebuilt and signed stand-alone EFI executable if the [secureboot](https://packages.gentoo.org/useflags/secureboot) [USE flag/ta (page does not exist)](/index.php?title=USE_flag/ta&action=edit&redlink=1 "USE flag/ta (page does not exist)") USE flag is enabled. Install the required packages and copy the stand-alone grub, Shim, and the MokManager to the same directory on the EFI System Partition. For example:
...
In the event that "EFI variables are not supported on this system" is displayed somewhere in the output, it is likely the live image was not booted in EFI mode and is presently in Legacy BIOS boot mode. The solution is to try the [removable GRUB step](/wiki/Handbook:AMD64/Blocks/Bootloader/ta#GRUB_Install_EFI_systems_removable "Handbook:AMD64/Blocks/Bootloader/ta") mentioned below. This will overwrite the executable EFI file located at /EFI/BOOT/BOOTX64.EFI. Upon rebooting in EFI mode, the motherboard firmware may execute this default boot entry and execute GRUB.
...
இணைக்கப்பட்டுள்ள இயக்ககத்தில் உள்ள மற்ற இயக்குதளங்களைக் கண்டறிய GRUB2 உடன் os-prober பயன்கூறு நிரலைப் பயன்படுத்திக் கொள்ளலாம். இது Windows 7, 8.1, 10 மற்றும் இதர லினக்ஸ் வழங்கல்களைக் கண்டறியும். இரு துவக்க முறைமையாகப் பயன்படுத்த விரும்புவோர், [sys-boot/os-prober](https://packages.gentoo.org/packages/sys-boot/os-prober) தொகுப்பை நிறுவி பின் grub-mkconfig கட்டளையை (மேலே உள்ளது போல்) மறு-இயக்கவும். இதில் எதாவது இடர்ப்பாடு ஏற்பட்டால், ஜென்டூ சமூகக்குழுவிடம் உதவி கேட்பதற்கு _முன்_ [GRUB2](/wiki/GRUB2 "GRUB2") கட்டுரையை முழுவதுமாக படித்து பொருள் உணர்ந்திருப்பதை உறுதிசெய்து கொள்ளவும்.
...
To install systemd-boot, enable the [boot](https://packages.gentoo.org/useflags/boot) [USE flag/ta (page does not exist)](/index.php?title=USE_flag/ta&action=edit&redlink=1 "USE flag/ta (page does not exist)") USE flag and re-install [sys-apps/systemd](https://packages.gentoo.org/packages/sys-apps/systemd) (for systemd systems) or [sys-apps/systemd-utils](https://packages.gentoo.org/packages/sys-apps/systemd-utils) (for OpenRC systems):
...
If no new entry exists, ensure the [sys-kernel/installkernel](https://packages.gentoo.org/packages/sys-kernel/installkernel) package has been installed with the [systemd](https://packages.gentoo.org/useflags/systemd) [USE flag/ta (page does not exist)](/index.php?title=USE_flag/ta&action=edit&redlink=1 "USE flag/ta (page does not exist)") and [systemd-boot](https://packages.gentoo.org/useflags/systemd-boot) [USE flag/ta (page does not exist)](/index.php?title=USE_flag/ta&action=edit&redlink=1 "USE flag/ta (page does not exist)") USE flags enabled, and re-run the kernel installation.
...
புதிதாக நிறுவப்பட்ட சென்டூ சூழலுக்குள் மறுஇயக்கம் செய்து சென்றவுடன், எல்லாவற்றையும் சிறப்பாக முடிக்க [நிறுவலை முடித்தலுக்கு](/wiki/Handbook:AMD64/Installation/Finalizing/ta "Handbook:AMD64/Installation/Finalizing/ta") செல்லவும்.

[← கருவிகளை நிறுவுதல்](/wiki/Handbook:AMD64/Installation/Tools/ta "Previous part") [Home](/wiki/Handbook:AMD64 "Handbook:AMD64") [நிறுவலை முடித்தல் →](/wiki/Handbook:AMD64/Installation/Finalizing/ta "Next part")