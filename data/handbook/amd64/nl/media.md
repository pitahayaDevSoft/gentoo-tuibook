...
- [4Writing the boot media](#Writing_the_boot_media)
  ...
  - [4.2Branden van de CD](#Branden_van_de_CD)
    - [4.2.1Burning with Microsoft Windows 7 and above](#Burning_with_Microsoft_Windows_7_and_above)
    - [4.2.2Branden met Linux](#Branden_met_Linux)
- [5Opstarten](#Opstarten)
  ...
  - [5.3Extra hardware configureren](#Extra_hardware_configureren)
  - [5.4Optioneel: Gebruikers accounts](#Optioneel:_Gebruikers_accounts)
  - [5.5Optioneel: documentatie opvragen tijdens de installatie](#Optioneel:_documentatie_opvragen_tijdens_de_installatie)
    - [5.5.1TTYs](#TTYs)
    - [5.5.2GNU Screen](#GNU_Screen)
  - [5.6Optioneel: de SSH daemon starten](#Optioneel:_de_SSH_daemon_starten)
...
Een stage3 tarball is een archief met een minimale Gentoo omgeving, waarmee de in deze handleiding beschreven installatie kan worden voltooid. In eerdere versies van het Gentoo Handboek werd de installatie beschreven waarbij gebruik kon worden gemaakt van een van drie [stage tarballs](/index.php?title=Stage_tarball/nl&action=edit&redlink=1 "Stage tarball/nl (page does not exist)") en hoewel de officiële installatie methode gebruik maakt van de stage3 tarball, zijn stage1 en stage2 tarballs nog steeds beschikbaar, zie hiervoor de Gentoo [FAQ (en)](/wiki/FAQ#How_do_I_install_Gentoo_using_a_stage1_or_stage2_tarball.3F "FAQ").

Stage3 tarballs kunnen gedownloaded worden van releases/amd64/autobuilds/ op een van de [officiële Gentoo mirrors](https://www.gentoo.org/downloads/mirrors/). Stage3 bestanden worden regelmatig geupdated en worden niet met de officiële installatie images meegeleverd.
...
Sommige architecturen hebben geen minimale installatie-cd's, voorbeelden zijn: **arm**, **mips** en **s390**. Op het moment wordt het bouwen van .iso-bestanden voor deze architecturen niet ondersteunt door het [Gentoo Release Engineering project](/wiki/Project:RelEng "Project:RelEng").
...
Om de cryptografische handtekening te controleren kunt u bijvoorbeeld [\[1\]](http://www.gpg4win.org/GPG4Win) gebruiken. Na installatie moeten de publieke sleutels van het Gentoo Release Engineering-team worden geimporteerd, de lijst met sleutels is beschikbaar op de [pagina met handtekeningen](https://www.gentoo.org/downloads/signatures/). Na het importeren kan de handtekening in het .DIGESTS.asc-bestand worden gecontroleerd.

#### Linux gebaseerde controle

Op een Linux-systeem is de meest gebruikelijke methode om de cruytografische handtekening te controleren met de [app-crypt/gnupg](https://packages.gentoo.org/packages/app-crypt/gnupg) software. Wanneer dit pakket is geinstalleerd kunnen de volgende opdrachten worden gebruikt om de digitale handtekening in het .DIGESTS.asc-bestand te controleren.

**Tip**

When importing Gentoo keys, verify that the 16-character key ID ( `BB572E0E2D182910`) matches.

Download eerst de juiste sleutels van de [pagina met handtekeningen](https://www.gentoo.org/downloads/signatures/).
...
Om volledig zekere te zijn dat alles juist is, dient de getoonde fingerprint overeen te komen met die op de [pagina met handtekeningen](https://www.gentoo.org/downloads/signatures/).
