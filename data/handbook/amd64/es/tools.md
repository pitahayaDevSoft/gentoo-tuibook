...
Ahora continúe con [Configurar el cargador de arranque](/wiki/Handbook:AMD64/Installation/Bootloader/es "Handbook:AMD64/Installation/Bootloader/es").

[← Configurar el sistema](/wiki/Handbook:AMD64/Installation/System/es "Previous part") [Inicio](/wiki/Handbook:AMD64/es "Handbook:AMD64/es") [Configurar el cargador de arranque →](/wiki/Handbook:AMD64/Installation/Bootloader/es "Next part")