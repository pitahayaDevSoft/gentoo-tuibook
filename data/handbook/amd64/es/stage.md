...
Una vez haya finalizada la descarga del archivo de stage, es posible verificar la integridad y validar los contenidos del archivo de stage. Los interesados pueden ir a la [siguiente sección](/wiki/Handbook:AMD64/Installation/Stage/es#Verifying_and_validating "Handbook:AMD64/Installation/Stage/es").

Aquellos que no estén interesados en verificar y validar el archivo de stage pueden cerrar el navegador de línea de comandos presionando `q` e ir directamente a la sección [Descomprimir el archivo de stage](/wiki/Handbook:AMD64/Installation/Stage/es#Unpacking_the_stage_file "Handbook:AMD64/Installation/Stage/es").
...
Ahora que el archivo stage está desempaquetado, continúe con [Configurara las opciones de compilación](/wiki/Handbook:AMD64/Installation/Stage/es#Configuring_compile_options "Handbook:AMD64/Installation/Stage/es").
...
[← Preparando los discos](/wiki/Handbook:AMD64/Installation/Disks/es "Previous part") [Inicio](/wiki/Handbook:AMD64/es "Handbook:AMD64/es") [Instalar el sistema base →](/wiki/Handbook:AMD64/Installation/Base/es "Next part")