...
次は [ブートローダーの設定](/wiki/Handbook:AMD64/Installation/Bootloader/ja "Handbook:AMD64/Installation/Bootloader/ja") です。

[← システムの設定](/wiki/Handbook:AMD64/Installation/System/ja "Previous part") [Home](/wiki/Handbook:AMD64/ja "Handbook:AMD64/ja") [ブートローダーの設定 →](/wiki/Handbook:AMD64/Installation/Bootloader/ja "Next part")