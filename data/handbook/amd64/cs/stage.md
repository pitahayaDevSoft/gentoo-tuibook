...
For all non-official live images which offer gpg and wget in the live environment, refer to the earlier [Verifying the downloaded files](/wiki/Handbook:AMD64/Installation/Media/cs#Verifying_the_downloaded_files "Handbook:AMD64/Installation/Media/cs") section.
...
[← Příprava disků](/wiki/Handbook:AMD64/Installation/Disks/cs "Previous part") [Home](/wiki/Handbook:AMD64 "Handbook:AMD64") [Instalace základního systému →](/wiki/Handbook:AMD64/Installation/Base/cs "Next part")