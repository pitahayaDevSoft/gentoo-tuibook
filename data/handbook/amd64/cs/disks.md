...
Později dojde k připojení systému souborů proc (virtuální rozhraní jádra) stejně jako dalších pseudo systémů souborů. Nejprve však [nainstalujeme instalační soubory Gentoo](/wiki/Handbook:AMD64/Installation/Stage/cs "Handbook:AMD64/Installation/Stage/cs").

[← Konfigurace sítě](/wiki/Handbook:AMD64/Installation/Networking/cs "Previous part") [Home](/wiki/Handbook:AMD64 "Handbook:AMD64") [Instalace stage3 →](/wiki/Handbook:AMD64/Installation/Stage/cs "Next part")