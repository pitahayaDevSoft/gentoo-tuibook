...
이제 [부트로더 설정](/wiki/Handbook:AMD64/Installation/Bootloader/ko "Handbook:AMD64/Installation/Bootloader/ko") 으로 계속 진행하십시오.

[← 시스템 설정](/wiki/Handbook:AMD64/Installation/System/ko "이전 내용") [처음](/wiki/Handbook:AMD64/ko "Handbook:AMD64/ko") [부트로더 설정 →](/wiki/Handbook:AMD64/Installation/Bootloader/ko "다음 내용")