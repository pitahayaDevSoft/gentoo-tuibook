...
**amd64** 에서는 BIOS 기반 시스템에서 [GRUB2](#.EA.B8.B0.EB.B3.B8:_GRUB2_.EC.82.AC.EC.9A.A9) 또는 [LILO](#.EB.8C.80.EC.95.88:_LILO_.EC.82.AC.EC.9A.A9) 를 설정하는 방법, UEFI 시스템에서 [GRUB2](#.EA.B8.B0.EB.B3.B8:_GRUB2_.EC.82.AC.EC.9A.A9) 또는 [efibootmgr](#.EB.8C.80.EC.95.88:_efibootmgr_.EC.82.AC.EC.9A.A9) 을 사용하는 방법을 문서에 남겨두었습니다.
...
Upon successful installation, the output should match the output of the previous command. If the output does not match exactly, then proceed to [Debugging GRUB](/wiki/Handbook:AMD64/Blocks/Bootloader/ko#Debugging_GRUB "Handbook:AMD64/Blocks/Bootloader/ko"), otherwise jump to the [Configure step](/wiki/Handbook:AMD64/Blocks/Bootloader/ko#GRUB_Configure "Handbook:AMD64/Blocks/Bootloader/ko").
...
In the event that "EFI variables are not supported on this system" is displayed somewhere in the output, it is likely the live image was not booted in EFI mode and is presently in Legacy BIOS boot mode. The solution is to try the [removable GRUB step](/wiki/Handbook:AMD64/Blocks/Bootloader/ko#GRUB_Install_EFI_systems_removable "Handbook:AMD64/Blocks/Bootloader/ko") mentioned below. This will overwrite the executable EFI file located at /EFI/BOOT/BOOTX64.EFI. Upon rebooting in EFI mode, the motherboard firmware may execute this default boot entry and execute GRUB.
...
새로 설치한 젠투 환경으로 다시 부팅하고 나면, [젠투 설치 마무리](/wiki/Handbook:AMD64/Installation/Finalizing/ko "Handbook:AMD64/Installation/Finalizing/ko") 로 끝내십시오.

[← 시스템 도구 설치](/wiki/Handbook:AMD64/Installation/Tools/ko "이전 내용") [처음](/wiki/Handbook:AMD64/ko "Handbook:AMD64/ko") [마무리 →](/wiki/Handbook:AMD64/Installation/Finalizing/ko "다음 내용")