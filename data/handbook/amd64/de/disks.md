...
In der Anleitung wird später das Dateisystem proc (eine virtuelle Schnittstelle zum Kernel) zusammen mit anderen Kernel Pseudo-Dateisystemen eingehängt. Zunächst installieren wir jedoch die [Gentoo Installationsdateien](/wiki/Handbook:AMD64/Installation/Stage/de "Handbook:AMD64/Installation/Stage/de").

[← Konfiguration des Netzwerks](/wiki/Handbook:AMD64/Installation/Networking/de "Previous part") [Anfang](/wiki/Handbook:AMD64/de "Handbook:AMD64/de") [Installation des Stage Archivs →](/wiki/Handbook:AMD64/Installation/Stage/de "Next part")