...
- [5Fájlrendszerek létrehozása](#F.C3.A1jlrendszerek_l.C3.A9trehoz.C3.A1sa)
  ...
  - [5.3Fájlrendszer rárakása egy partícióra](#F.C3.A1jlrendszer_r.C3.A1rak.C3.A1sa_egy_part.C3.ADci.C3.B3ra)
    - [5.3.1EFI rendszerpartíciónak a fájlrendszere](#EFI_rendszerpart.C3.ADci.C3.B3nak_a_f.C3.A1jlrendszere)
    - [5.3.2Örökölt BIOS rendszerindító partíciónak a fájlrendszere](#.C3.96r.C3.B6k.C3.B6lt_BIOS_rendszerind.C3.ADt.C3.B3_part.C3.ADci.C3.B3nak_a_f.C3.A1jlrendszere)
    - [5.3.3Kicsi ext4 partíciók](#Kicsi_ext4_part.C3.ADci.C3.B3k)
...
/dev/sda2Nem alkalmazható A swap nem úgy van csatlakoztatva a fájlrendszerhez, mint egy eszközfájl.swap
...
/dev/sda2Nem alkalmazható A cserepartíció nem úgy van felcsatlakoztatva a fájlrendszerhez, mint egy eszközfájl.swap
0657fd6d-a4ab-43c4-84e5-0933c84b4f4f
...
Most, hogy a partíciók elkészültek, ideje fájlrendszert helyezni rájuk. A következő részben a Linux által támogatott különféle fájlrendszereket ismertetjük. Azok az olvasók, akik már tudják, hogy melyik fájlrendszert fogják használni, folytathatják a [Fájlrendszer rárakása egy partícióra](/wiki/Handbook:AMD64/Installation/Disks/hu#Applying_a_filesystem_to_a_partition "Handbook:AMD64/Installation/Disks/hu") című bekezdéssel. A többi felhasználónak érdemes továbbolvasniuk, hogy megismerjék az alkalmazható fájlrendszereket...
...
Később az utasításokban a proc fájlrendszer (a kernellel kapcsolatban álló virtuális interfész) és a többi kernel pszeudofájlrendszer lesz felcsatolva. Először viszont még a [Gentoo-stage fájlt](/wiki/Handbook:AMD64/Installation/Stage/hu "Handbook:AMD64/Installation/Stage/hu") ki kell csomagolnunk.

[← Hálózat beállítása](/wiki/Handbook:AMD64/Installation/Networking/hu "Previous part") [Kezdőlap](/wiki/Handbook:AMD64/hu "Handbook:AMD64/hu") [Stage fájl telepítése →](/wiki/Handbook:AMD64/Installation/Stage/hu "Next part")