...
Miután a stage fájl letöltése befejeződött, lehetőség van a stage fájl integritásának ellenőrzésére és tartalmának érvényesítésére. Az eziránt érdeklődők az olvasást folytassák a [következő szakaszban](/wiki/Handbook:AMD64/Installation/Stage/hu#Verifying_and_validating "Handbook:AMD64/Installation/Stage/hu").

Azok, akik nem szeretnék ellenőrizni és érvényesíteni a stage fájlt, kiléphetnek a parancssoros böngészőből a `q` billentyűgomb megnyomásával, és közvetlenül áttérhetnek az [Stage fájl telepítése](/wiki/Handbook:AMD64/Installation/Stage/hu#Unpacking_the_stage_tarball "Handbook:AMD64/Installation/Stage/hu") szakaszra.
...
Most, hogy a stage fájl ki lett csomagolva, folytassa a [kódfordítási beállításoknak a szerkesztésével](/wiki/Handbook:AMD64/Installation/Stage/hu#Configuring_compile_options "Handbook:AMD64/Installation/Stage/hu").
...
[← Adathordozók előkészítése](/wiki/Handbook:AMD64/Installation/Disks/hu "Previous part") [Kezdőlap](/wiki/Handbook:AMD64/hu "Handbook:AMD64/hu") [Alaprendszer telepítése →](/wiki/Handbook:AMD64/Installation/Base/hu "Next part")