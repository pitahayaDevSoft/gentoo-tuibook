...
Upon successful installation, the output should match the output of the previous command. If the output does not match exactly, then proceed to [Debugging GRUB](/wiki/Handbook:AMD64/Blocks/Bootloader/ru#Debugging_GRUB "Handbook:AMD64/Blocks/Bootloader/ru"), otherwise jump to the [Configure step](/wiki/Handbook:AMD64/Blocks/Bootloader/ru#GRUB_Configure "Handbook:AMD64/Blocks/Bootloader/ru").
...
In the event that "EFI variables are not supported on this system" is displayed somewhere in the output, it is likely the live image was not booted in EFI mode and is presently in Legacy BIOS boot mode. The solution is to try the [removable GRUB step](/wiki/Handbook:AMD64/Blocks/Bootloader/ru#GRUB_Install_EFI_systems_removable "Handbook:AMD64/Blocks/Bootloader/ru") mentioned below. This will overwrite the executable EFI file located at /EFI/BOOT/BOOTX64.EFI. Upon rebooting in EFI mode, the motherboard firmware may execute this default boot entry and execute GRUB.
...
Перезагрузившись в новое окружение Gentoo, переходите к [завершению установки Gentoo](/wiki/Handbook:AMD64/Installation/Finalizing/ru "Handbook:AMD64/Installation/Finalizing/ru").

[← Установка системных средств](/wiki/Handbook:AMD64/Installation/Tools/ru "Предыдущая часть") [К содержанию](/wiki/Handbook:AMD64/ru "Handbook:AMD64/ru") [Завершение →](/wiki/Handbook:AMD64/Installation/Finalizing/ru "Следующая часть")