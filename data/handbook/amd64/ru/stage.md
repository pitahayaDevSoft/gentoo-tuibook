...
После завершения скачивания можно проверить целостность и достоверность содержимого файла stage. Если вам это интересно, перейдите к [следующему разделу](/wiki/Handbook:AMD64/Installation/Stage/ru#Verifying_and_validating "Handbook:AMD64/Installation/Stage/ru").

Тем, кому не интересно проверять архив stage, могут закрыть браузер в командной строке с помощью клавиши `q` и сразу перейти к разделу [Распаковка файла stage](/wiki/Handbook:AMD64/Installation/Stage/ru#Unpacking_the_stage_file "Handbook:AMD64/Installation/Stage/ru").
...
Для неофициальных образов, которые содержат утилиты gpg и wget, см. предыдущий раздел [Проверка скачанных файлов](/wiki/Handbook:AMD64/Installation/Media/ru#Verifying_the_downloaded_files "Handbook:AMD64/Installation/Media/ru").
...
Теперь, когда stage распакован, перейдём к [настройке параметров компиляции](/wiki/Handbook:AMD64/Installation/Stage/ru#Configuring_compile_options "Handbook:AMD64/Installation/Stage/ru").
...
[← Подготовка дисков](/wiki/Handbook:AMD64/Installation/Disks/ru "Предыдущая часть") [К содержанию](/wiki/Handbook:AMD64/ru "Handbook:AMD64/ru") [Установка базовой системы Gentoo →](/wiki/Handbook:AMD64/Installation/Base/ru "Следующая часть")