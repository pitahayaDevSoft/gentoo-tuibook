...
Ora si prosegua con [Configurare il programma d'avvio](/wiki/Handbook:AMD64/Installation/Bootloader/it "Handbook:AMD64/Installation/Bootloader/it").

[← Configurare il sistema](/wiki/Handbook:AMD64/Installation/System/it "Previous part") [Home](/wiki/Handbook:AMD64 "Handbook:AMD64") [Configurare programma d'avvio →](/wiki/Handbook:AMD64/Installation/Bootloader/it "Next part")