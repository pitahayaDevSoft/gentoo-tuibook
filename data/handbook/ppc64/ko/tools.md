...
이제 [부트로더 설정](/wiki/Handbook:PPC64/Installation/Bootloader/ko "Handbook:PPC64/Installation/Bootloader/ko") 으로 계속 진행하십시오.

[← 시스템 설정](/wiki/Handbook:PPC64/Installation/System/ko "이전 내용") [처음](/wiki/Handbook:PPC64/ko "Handbook:PPC64/ko") [부트로더 설정 →](/wiki/Handbook:PPC64/Installation/Bootloader/ko "다음 내용")