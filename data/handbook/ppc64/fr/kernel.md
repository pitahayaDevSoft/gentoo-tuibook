...
- [4Configuration et compilation du noyau](#Configuration_et_compilation_du_noyau)
  ...
  - [4.4Compiler et installler](#Compiler_et_installler)
...
Installer certains micrologiciels nécessite souvent d’accepter la licence associée. Si nécessaire, visitez la [section gestion des licences](/wiki/Handbook:PPC64/Working/Portage/fr#Licenses "Handbook:PPC64/Working/Portage/fr") du manuel pour de l’aide à propos des licences.
...
Les _[noyaux distribués](/wiki/Project:Distribution_Kernel "Project:Distribution Kernel")_, comme [sys-kernel/gentoo-kernel](https://packages.gentoo.org/packages/sys-kernel/gentoo-kernel) et [sys-kernel/gentoo-kernel-bin](https://packages.gentoo.org/packages/sys-kernel/gentoo-kernel-bin) attendent par défaut d’être installés à côté de [initramfs](/wiki/Handbook:PPC64/Installation/Kernel#Initramfs.2Ffr "Handbook:PPC64/Installation/Kernel"). Avant de lancer _emerge_ pour installer le noyau, les utilisateurs doivent s’assurer que [sys-kernel/installkernel](https://packages.gentoo.org/packages/sys-kernel/installkernel) est bien configuré pour utiliser un générateur _initramfs_ (par exemple [Dracut](/wiki/Dracut "Dracut")) comme décrit dans la section [_installkernel_](/wiki/Handbook:PPC64/Installation/Kernel#Initramfs.2Ffr "Handbook:PPC64/Installation/Kernel").
...
Après avoir installé le noyau distribué avec succès, il est maintenant possible de continuer dans la prochaine section : [Configurer le système](/wiki/Handbook:PPC64/Installation/System/fr "Handbook:PPC64/Installation/System/fr").

### Approche manuelle

### Installer les sources du noyau

Lors de l’installation et la compilation du noyau pour les systèmes basés sur ppc64, Gentoo recommande le paquet [sys-kernel/gentoo-sources](https://packages.gentoo.org/packages/sys-kernel/gentoo-sources).
...
For now please follow installing [sys-kernel/gentoo-kernel-bin](https://packages.gentoo.org/packages/sys-kernel/gentoo-kernel-bin) via [Distribution\_kernels](/wiki/Handbook:PPC64/Installation/Kernel#Distribution_kernels.2Ffr "Handbook:PPC64/Installation/Kernel").
...
Now it's time to decide if modules signing is required in the steps listed in [here](/wiki/Handbook:PPC64/Installation/Kernel#Optional:_Signed_kernel_modules_2.2Ffr "Handbook:PPC64/Installation/Kernel")

If not, proceed to building described [here](/wiki/Handbook:PPC64/Installation/Kernel#Compiling_and_installing.2Ffr "Handbook:PPC64/Installation/Kernel")
...
{{#switch: ppc64 \| amd64 \| arm64 \| riscv \| x86 =
