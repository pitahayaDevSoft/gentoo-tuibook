...
Nachdem Sie das Stage Tar-Archiv erfolgreich heruntergeladen haben, können Sie die Integrität des Tar-Archivs verifizieren und den Inhalt validieren. Wie das geht, steht im [folgenden Abschnitt](/wiki/Handbook:PPC64/Installation/Stage/de#Verifying_and_validating "Handbook:PPC64/Installation/Stage/de").

Wenn Sie kein Interesse an einer Überprüfung und Validierung des Stage Tar-Archivs haben, können Sie jetzt `q` drücken, um den Browser zu beenden. Springen Sie danach zu dem Abschnitt [Stage Tar-Archiv entpacken](/wiki/Handbook:PPC64/Installation/Stage/de#Unpacking_the_stage_tarball "Handbook:PPC64/Installation/Stage/de").
...
For all non-official live images which offer gpg and wget in the live environment, refer to the earlier [Verifying the downloaded files](/wiki/Handbook:PPC64/Installation/Media/de#Verifying_the_downloaded_files "Handbook:PPC64/Installation/Media/de") section.
...
Nachdem nun das Stage Tar-Archiv ausgepackt ist, geht es weiter mit dem Schritt: [Compiler-Optionen konfigurieren](/wiki/Handbook:PPC64/Installation/Stage/de#Configuring_compile_options "Handbook:PPC64/Installation/Stage/de").
...
[← Vorbereiten der Festplatte(n)](/wiki/Handbook:PPC64/Installation/Disks/de "Previous part") [Anfang](/wiki/Handbook:PPC64/de "Handbook:PPC64/de") [Installation des Basissystems →](/wiki/Handbook:PPC64/Installation/Base/de "Next part")