...
- [2Gentoo Linux Installations-Medien](#Gentoo_Linux_Installations-Medien)
  ...
  - [2.2Was sind Stage-Dateien?](#Was_sind_Stage-Dateien.3F)
...
- [5Booten](#Booten)
  - [5.1Standard: Booten der Installations-CD auf einem Apple/IBM](#Standard:_Booten_der_Installations-CD_auf_einem_Apple.2FIBM)
  - [5.2IBM pSerie](#IBM_pSerie)
  - [5.3Tastaturlayout einstellen](#Tastaturlayout_einstellen)
  - [5.4LiveGUI root access](#LiveGUI_root_access)
  - [5.5Erweiterte Hardwarekonfiguration](#Erweiterte_Hardwarekonfiguration)
  - [5.6Optional: Benutzerkonten](#Optional:_Benutzerkonten)
  - [5.7Optional: Lesen der Dokumentation während der Installation](#Optional:_Lesen_der_Dokumentation_w.C3.A4hrend_der_Installation)
    - [5.7.1TTYs](#TTYs)
    - [5.7.2GNU Screen](#GNU_Screen)
  - [5.8Optional: Starten des SSH-Daemons](#Optional:_Starten_des_SSH-Daemons)

## Hardware-Anforderungen

Bevor Sie mit dem Installationsprozess fortfahren, sollten Sie die Mindestanforderungen an die Hardware erfüllen, um Gentoo erfolgreich für die Systemarchitektur **ppc64** zu installieren.
...
[Vorbereiten der Festplatte(n)](/wiki/Handbook:PPC64/Installation/Disks/de "Handbook:PPC64/Installation/Disks/de").
...
Die Minimal-Installations-CDs werden im folgendem Format benannt: install-ppc64-minimal-<release>.iso.
...
Stage3-Dateien können aus dem Verzeichnis releases/ppc64/autobuilds/ von einem der [offiziellen Gentoo Spiegel-Server (Mirror-Server)](https://www.gentoo.org/downloads/mirrors/) heruntergeladen werden. Die Stage3-Dateien werden häufig aktualisiert und sind daher nicht auf den offiziellen Installations-Images enthalten.
...
2. Gehen Sie in das Verzeichnis für die richtige Architektur, z.B. **ppc64/**
...
CODE **Beispiel-Listing des Verzeichnisses releases/ppc64/autobuilds/current-iso/**
...
An diesem Prompt kann der Standard Linux Kernel (genannt _gentoo_) gebootet werden, der von der Installations-CD weiter bootet.
...
`aty128`,
`nvidiafb` oder
`ofonly`. Hängen Sie an diese Tags die benötigte Auflösung und Wiederholrate an. Beispielsweise `video=radeonfb:1280x1024@75`. Wenn Sie unsicher sind was hier auszuwählen ist, wird `ofonly` am wahrscheinlichsten funktionieren.
...
`user $` `links https://wiki.gentoo.org/wiki/Handbook:PPC64/de`
...
Um sshd nutzen zu können, müssen Sie zunächst das Netzwerk einrichten. Setzen Sie die Installation mit der [Konfiguration des Netzwerks](/wiki/Handbook:PPC64/Installation/Networking/de "Handbook:PPC64/Installation/Networking/de") fort.

[← Über die Installation](/wiki/Handbook:PPC64/Installation/About/de "Previous part") [Anfang](/wiki/Handbook:PPC64/de "Handbook:PPC64/de") [Konfiguration des Netzwerks →](/wiki/Handbook:PPC64/Installation/Networking/de "Next part")