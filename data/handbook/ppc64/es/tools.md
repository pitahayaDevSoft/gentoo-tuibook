...
Ahora continúe con [Configurar el cargador de arranque](/wiki/Handbook:PPC64/Installation/Bootloader/es "Handbook:PPC64/Installation/Bootloader/es").

[← Configurar el sistema](/wiki/Handbook:PPC64/Installation/System/es "Previous part") [Inicio](/wiki/Handbook:PPC64/es "Handbook:PPC64/es") [Configurar el cargador de arranque →](/wiki/Handbook:PPC64/Installation/Bootloader/es "Next part")