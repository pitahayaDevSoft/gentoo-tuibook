...
- [தமிழ்](/wiki/Handbook:PPC64/Installation/System/ta "கையேடு:PPC64/நிறுவல்/முறைமை (100% translated)")
...
En el ejemplo de particionamiento para **ppc64**, /boot normalmente es la partición /dev/sda1, con xfs como sistema de archivos recomendado. Es necesario comprobarlo durante el arranque, por lo que anotaríamos:
...
Se puede obtener información más detallada sobre redes, incluyendo temas más avanzados como bonding, bridging, 802.1 Q VLANs o conexiones de red inalámbrica en la sección de [configuración avanzada de la red](/wiki/Handbook:PPC64/Networking/Introduction/es "Handbook:PPC64/Networking/Introduction/es").
...
[← Configurar el núcleo](/wiki/Handbook:PPC64/Installation/Kernel/es "Previous part") [Inicio](/wiki/Handbook:PPC64/es "Handbook:PPC64/es") [Instalar las herramientas →](/wiki/Handbook:PPC64/Installation/Tools/es "Next part")