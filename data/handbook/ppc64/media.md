...
### Default: Booting the installation CD on an Apple/IBM\[ [edit](/index.php?title=Handbook:PPC64/Blocks/Booting&action=edit&section=T-1 "Edit section: ")\]
...
### IBM pSeries\[ [edit](/index.php?title=Handbook:PPC64/Blocks/Booting&action=edit&section=T-2 "Edit section: ")\]
...
### Setting keyboard layout\[ [edit](/index.php?title=Handbook:PPC64/Blocks/Booting&action=edit&section=T-3 "Edit section: ")\]
...
To be able to use sshd, the network needs to function properly. Continue with the chapter on [Configuring the network](/wiki/Handbook:PPC64/Installation/Networking "Handbook:PPC64/Installation/Networking").
