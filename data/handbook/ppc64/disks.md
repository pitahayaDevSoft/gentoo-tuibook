...
### Partitions and slices\[ [edit](/index.php?title=Handbook:PPC64/Blocks/Disks&action=edit&section=T-1 "Edit section: ")\]
...
## Default: Using mac-fdisk\[ [edit](/index.php?title=Handbook:PPC64/Blocks/Disks&action=edit&section=T-2 "Edit section: ")\]
...
## Alternative: Using fdisk\[ [edit](/index.php?title=Handbook:PPC64/Blocks/Disks&action=edit&section=T-3 "Edit section: ")\]
...
### Viewing current partition layout\[ [edit](/index.php?title=Handbook:PPC64/Blocks/Disks&action=edit&section=T-4 "Edit section: ")\]
...
### Removing all partitions\[ [edit](/index.php?title=Handbook:PPC64/Blocks/Disks&action=edit&section=T-5 "Edit section: ")\]
...
### Creating the PPC PReP boot partition\[ [edit](/index.php?title=Handbook:PPC64/Blocks/Disks&action=edit&section=T-6 "Edit section: ")\]
...
### Creating the swap partition\[ [edit](/index.php?title=Handbook:PPC64/Blocks/Disks&action=edit&section=T-7 "Edit section: ")\]
...
### Creating the root partition\[ [edit](/index.php?title=Handbook:PPC64/Blocks/Disks&action=edit&section=T-8 "Edit section: ")\]
...
### Saving the partition layout\[ [edit](/index.php?title=Handbook:PPC64/Blocks/Disks&action=edit&section=T-9 "Edit section: ")\]
...
Now that the partitions have been created, it is time to place a filesystem on them. In the next section the various file systems that Linux supports are described. Readers that already know which filesystem to use can continue with [Applying a filesystem to a partition](/wiki/Handbook:PPC64/Installation/Disks#Applying_a_filesystem_to_a_partition "Handbook:PPC64/Installation/Disks"). The others should read on to learn about the available filesystems...
...
Later in the instructions, the proc filesystem (a virtual interface with the kernel) as well as other kernel pseudo-filesystems will be mounted. But first [the Gentoo stage file](/wiki/Handbook:PPC64/Installation/Stage "Handbook:PPC64/Installation/Stage") must be extracted.
