...
次は [ブートローダーの設定](/wiki/Handbook:PPC64/Installation/Bootloader/ja "Handbook:PPC64/Installation/Bootloader/ja") です。

[← システムの設定](/wiki/Handbook:PPC64/Installation/System/ja "Previous part") [Home](/wiki/Handbook:PPC64/ja "Handbook:PPC64/ja") [ブートローダーの設定 →](/wiki/Handbook:PPC64/Installation/Bootloader/ja "Next part")