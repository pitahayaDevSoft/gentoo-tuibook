...
Now continue with [Configuring the bootloader](/wiki/Handbook:PPC64/Installation/Bootloader "Handbook:PPC64/Installation/Bootloader").

[← Configuring the system](/wiki/Handbook:PPC64/Installation/System "Previous part") [Home](/wiki/Handbook:PPC64 "Handbook:PPC64") [Configuring the bootloader →](/wiki/Handbook:PPC64/Installation/Bootloader "Next part")