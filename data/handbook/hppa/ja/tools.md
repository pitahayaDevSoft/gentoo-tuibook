...
次は [ブートローダーの設定](/wiki/Handbook:HPPA/Installation/Bootloader/ja "Handbook:HPPA/Installation/Bootloader/ja") です。

[← システムの設定](/wiki/Handbook:HPPA/Installation/System/ja "Previous part") [Home](/wiki/Handbook:HPPA/ja "Handbook:HPPA/ja") [ブートローダーの設定 →](/wiki/Handbook:HPPA/Installation/Bootloader/ja "Next part")