...
Installare certi pacchetti firmware spesso richiede l'accettazione di licenze associate al firmware. Se necessario, visitare la [sezione di gestione delle licenze](/wiki/Handbook:HPPA/Working/Portage/it#Licenses "Handbook:HPPA/Working/Portage/it") del manuale per aiuto sull'accettazione delle licenze.
...
Ora è tempo di decidere se la firma dei moduli è necessaria nei passaggi elencati [qui](/wiki/Handbook:HPPA/Installation/Kernel#Optional:_Signed_kernel_modules_2.2Fit "Handbook:HPPA/Installation/Kernel").

Altrimenti, proseguire con la compilazione come descritta [qui](/wiki/Handbook:HPPA/Installation/Kernel#Compiling_and_installing.2Fit "Handbook:HPPA/Installation/Kernel").
...
[Handbook:HPPA/Blocks/Kernel/it](/index.php?title=Handbook:HPPA/Blocks/Kernel/it&action=edit&redlink=1 "Handbook:HPPA/Blocks/Kernel/it (page does not exist)")

Continuare l'installazione con [configurare il sistema](/wiki/Handbook:HPPA/Installation/System/it "Handbook:HPPA/Installation/System/it").

[← Installare il sistema base](/wiki/Handbook:HPPA/Installation/Base/it "Previous part") [Home](/wiki/Handbook:HPPA "Handbook:HPPA") [Configurare il sistema →](/wiki/Handbook:HPPA/Installation/System/it "Next part")