...
Ora si prosegua con [Configurare il programma d'avvio](/wiki/Handbook:HPPA/Installation/Bootloader/it "Handbook:HPPA/Installation/Bootloader/it").

[← Configurare il sistema](/wiki/Handbook:HPPA/Installation/System/it "Previous part") [Home](/wiki/Handbook:HPPA "Handbook:HPPA") [Configurare programma d'avvio →](/wiki/Handbook:HPPA/Installation/Bootloader/it "Next part")