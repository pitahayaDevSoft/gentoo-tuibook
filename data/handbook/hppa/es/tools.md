...
Ahora continúe con [Configurar el cargador de arranque](/wiki/Handbook:HPPA/Installation/Bootloader/es "Handbook:HPPA/Installation/Bootloader/es").

[← Configurar el sistema](/wiki/Handbook:HPPA/Installation/System/es "Previous part") [Inicio](/wiki/Handbook:HPPA/es "Handbook:HPPA/es") [Configurar el cargador de arranque →](/wiki/Handbook:HPPA/Installation/Bootloader/es "Next part")