...
To be able to use sshd, the network needs to function properly. Continue with the chapter on [Configuring the network](/wiki/Handbook:HPPA/Installation/Networking/pl "Handbook:HPPA/Installation/Networking/pl").
