...
After the stage file download completes, it is possible to verify the integrity and validate the contents of the stage file. Those interested should proceed to the [next section](/wiki/Handbook:HPPA/Installation/Stage/pl#Verifying_and_validating "Handbook:HPPA/Installation/Stage/pl").

Those not interested in verifying and validating the stage file can close the command-line browser by pressing `q` and can move directly to the [Unpacking the stage file](/wiki/Handbook:HPPA/Installation/Stage/pl#Unpacking_the_stage_file "Handbook:HPPA/Installation/Stage/pl") section.
...
For all non-official live images which offer gpg and wget in the live environment, refer to the earlier [Verifying the downloaded files](/wiki/Handbook:HPPA/Installation/Media/pl#Verifying_the_downloaded_files "Handbook:HPPA/Installation/Media/pl") section.
...
Now that the stage file is unpacked, proceed with [Configuring compile options](/wiki/Handbook:HPPA/Installation/Stage/pl#Configuring_compile_options "Handbook:HPPA/Installation/Stage/pl").
