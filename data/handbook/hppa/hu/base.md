...
Ha a Gentoo telepítése ezen a ponton bárhol megszakad, akkor ettől a lépéstől _lehetséges_ a telepítés _folytatása_. Nincs szükség az adathordozók újraparticionálására! Egyszerűen [csatolja fel a gyökérpartíciót](/wiki/Handbook:HPPA/Installation/Disks/hu#Mounting_the_root_partition "Handbook:HPPA/Installation/Disks/hu"), és hajtsa végre a fentiekben leírt lépéseket, kezdve a [DNS információ másolásával](/wiki/Handbook:HPPA/Installation/Base/hu#Copy_DNS_info "Handbook:HPPA/Installation/Base/hu"), hogy újra belépjen a munkakörnyezetbe. Ez hasznos lehet a bootloader problémák javításához is. További információk a [chroot](/wiki/Chroot/hu "Chroot/hu") cikkben találhatók.
...
Az hppa architektúra elérhető profiljainak a megtekintése után a felhasználók kiválaszthatnak egy másik profilt a rendszerhez:
...
A binhost szoftvercsomag-tároló beállítása a Portage /etc/portage/binrepos.conf/ könyvtárában található, amely hasonlóan működik a [Gentoo ebuild tároló](/wiki/Handbook:HPPA/Installation/Base/hu#Gentoo_ebuild_repository "Handbook:HPPA/Installation/Base/hu") szakaszában említett beállításhoz.

Bináris számítógép meghatározásakor két fontos szempontot kell figyelembe venni:

1. A `sync-uri` értékében szereplő architektúra és profil célpontok _valóban_ számítanak, és igazodniuk kell a megfelelő számítógép architektúrához (ebben az esetben **hppa**) és a [Megfelelő profil kiválasztása](/wiki/Handbook:HPPA/Installation/Base/hu#Choosing_the_right_profile "Handbook:HPPA/Installation/Base/hu") szakaszban kiválasztott rendszerprofilhoz.
2. Egy gyors, földrajzilag közeli tükörszerver kiválasztása általában lerövidíti a letöltési időt. Tekintse át a mirrorselect eszközt, amely az [Opcionális: Tükrök kiválasztása](/wiki/Handbook:HPPA/Installation/Base/hu#Gentoo_ebuild_repository "Handbook:HPPA/Installation/Base/hu") szakaszban található, vagy tekintse át az [online tükörszerverek listáját](https://www.gentoo.org/downloads/mirrors/), ahol URL értékeket találhat.
...
A Portage szoftvercsomag-kezelő további funkcióit a kézikönyv [következő fejezetében](/wiki/Handbook:HPPA/Working/Features/hu#Portage_features "Handbook:HPPA/Working/Features/hu") tárgyaljuk.
...
Azok az olvasók, akik hozzáadtak egy bináris kiszolgálót a [fenti](/wiki/Handbook:HPPA/Installation/Base/hu#Optional:_Adding_a_binary_package_host "Handbook:HPPA/Installation/Base/hu") szakaszban, megadhatják a --getbinpkg (vagy -g) opciót, hogy szoftvercsomagokat töltsenek le a bináris kiszolgálóról ahelyett, hogy azokat lefordítanák:
...
[← Stage fájl telepítése](/wiki/Handbook:HPPA/Installation/Stage/hu "Previous part") [Kezdőlap](/wiki/Handbook:HPPA/hu "Handbook:HPPA/hu") [Kernel beállítása →](/wiki/Handbook:HPPA/Installation/Kernel/hu "Next part")