...
Nem tudja, merre induljon tovább? Számos út létezik a felfedezésre... A Gentoo rengeteg lehetőséget kínál felhasználóinak, és ezért sok dokumentált (és kevésbé dokumentált) funkciót kell felfedezni itt a wiki-n és más Gentoo-hoz kapcsolódó aldoménekben (tekintse meg az alábbi [Gentoo online](/wiki/Handbook:HPPA/Installation/Finalizing/hu#Gentoo_online "Handbook:HPPA/Installation/Finalizing/hu") szakaszt).
...
Az olvasóknak mindenképpen érdemes megnézniük a kézikönyv következő részét, amelynek címe: [Working with Gentoo](/wiki/Handbook:HPPA/Working/Portage/hu "Handbook:HPPA/Working/Portage/hu"), amely elmagyarázza, hogyan tarthatják naprakészen a szoftvereket, hogyan telepíthetnek további szoftvercsomagokat, részleteket a USE zászlókról, az OpenRC init rendszerről és számos más hasznos témáról a Gentoo rendszer telepítés utáni kezelésével kapcsolatban.
...
[← Bootloader beállítása](/wiki/Handbook:HPPA/Installation/Bootloader/hu "Previous part") [Kezdőlap](/wiki/Handbook:HPPA/hu "Handbook:HPPA/hu") [Portage bemutatása →](/wiki/Handbook:HPPA/Working/Portage/hu "Next part")