...
Most folytassa a [Bootloader beállítása](/wiki/Handbook:HPPA/Installation/Bootloader/hu "Handbook:HPPA/Installation/Bootloader/hu") részével.

[← Rendszer beállítása](/wiki/Handbook:HPPA/Installation/System/hu "Previous part") [Kezdőlap](/wiki/Handbook:HPPA/hu "Handbook:HPPA/hu") [Bootloader beállítása →](/wiki/Handbook:HPPA/Installation/Bootloader/hu "Next part")