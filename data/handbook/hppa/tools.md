...
Now continue with [Configuring the bootloader](/wiki/Handbook:HPPA/Installation/Bootloader "Handbook:HPPA/Installation/Bootloader").

[← Configuring the system](/wiki/Handbook:HPPA/Installation/System "Previous part") [Home](/wiki/Handbook:HPPA "Handbook:HPPA") [Configuring the bootloader →](/wiki/Handbook:HPPA/Installation/Bootloader "Next part")