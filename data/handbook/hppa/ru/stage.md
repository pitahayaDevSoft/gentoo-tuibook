...
После завершения скачивания можно проверить целостность и достоверность содержимого файла stage. Если вам это интересно, перейдите к [следующему разделу](/wiki/Handbook:HPPA/Installation/Stage/ru#Verifying_and_validating "Handbook:HPPA/Installation/Stage/ru").

Тем, кому не интересно проверять архив stage, могут закрыть браузер в командной строке с помощью клавиши `q` и сразу перейти к разделу [Распаковка файла stage](/wiki/Handbook:HPPA/Installation/Stage/ru#Unpacking_the_stage_file "Handbook:HPPA/Installation/Stage/ru").
...
Для неофициальных образов, которые содержат утилиты gpg и wget, см. предыдущий раздел [Проверка скачанных файлов](/wiki/Handbook:HPPA/Installation/Media/ru#Verifying_the_downloaded_files "Handbook:HPPA/Installation/Media/ru").
...
Теперь, когда stage распакован, перейдём к [настройке параметров компиляции](/wiki/Handbook:HPPA/Installation/Stage/ru#Configuring_compile_options "Handbook:HPPA/Installation/Stage/ru").
...
[← Подготовка дисков](/wiki/Handbook:HPPA/Installation/Disks/ru "Предыдущая часть") [К содержанию](/wiki/Handbook:HPPA/ru "Handbook:HPPA/ru") [Установка базовой системы Gentoo →](/wiki/Handbook:HPPA/Installation/Base/ru "Следующая часть")