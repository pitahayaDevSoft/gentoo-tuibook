...
[Sommaire du manuel](/wiki/Handbook:X86 "Handbook:X86")[Installation](/wiki/Handbook:X86/Full/Installation/fr "Handbook:X86/Full/Installation/fr")[À propos de l’installation](/wiki/Handbook:X86/Installation/About/fr "Handbook:X86/Installation/About/fr")[Choix du support](/wiki/Handbook:X86/Installation/Media/fr "Handbook:X86/Installation/Media/fr")[Configurer le réseau](/wiki/Handbook:X86/Installation/Networking/fr "Handbook:X86/Installation/Networking/fr")[Préparer les disques](/wiki/Handbook:X86/Installation/Disks/fr "Handbook:X86/Installation/Disks/fr")[Installer l’archive _stage3_](/wiki/Handbook:X86/Installation/Stage/fr "Handbook:X86/Installation/Stage/fr")[Installer le système de base](/wiki/Handbook:X86/Installation/Base/fr "Handbook:X86/Installation/Base/fr")Configurer le noyau[Configurer le système](/wiki/Handbook:X86/Installation/System/fr "Handbook:X86/Installation/System/fr")[Installer les outils](/wiki/Handbook:X86/Installation/Tools/fr "Handbook:X86/Installation/Tools/fr")[Configurer le système d’amorçage](/wiki/Handbook:X86/Installation/Bootloader/fr "Handbook:X86/Installation/Bootloader/fr")[Finaliser](/wiki/Handbook:X86/Installation/Finalizing/fr "Handbook:X86/Installation/Finalizing/fr")[Utiliser Gentoo](/wiki/Handbook:X86/Full/Working/fr "Handbook:X86/Full/Working/fr")[Introduction à Portage](/wiki/Handbook:X86/Working/Portage/fr "Handbook:X86/Working/Portage/fr")[Les options de la variable USE](/wiki/Handbook:X86/Working/USE/fr "Handbook:X86/Working/USE/fr")[Les fonctionnalités de Portage](/wiki/Handbook:X86/Working/Features/fr "Handbook:X86/Working/Features/fr")[Scripts d’initialisation systèmes](/wiki/Handbook:X86/Working/Initscripts/fr "Handbook:X86/Working/Initscripts/fr")[Variables d’environnement](/wiki/Handbook:X86/Working/EnvVar/fr "Handbook:X86/Working/EnvVar/fr")[Utiliser Portage](/wiki/Handbook:X86/Full/Portage/fr "Handbook:X86/Full/Portage/fr")[Fichiers et répertoires](/wiki/Handbook:X86/Portage/Files/fr "Handbook:X86/Portage/Files/fr")[Les variables](/wiki/Handbook:X86/Portage/Variables/fr "Handbook:X86/Portage/Variables/fr")[Mélanger plusieurs branches logicielles](/wiki/Handbook:X86/Portage/Branches/fr "Handbook:X86/Portage/Branches/fr")[Outils supplémentaires](/wiki/Handbook:X86/Portage/Tools/fr "Handbook:X86/Portage/Tools/fr")[Dépôt personnalisé](/wiki/Handbook:X86/Portage/CustomTree/fr "Handbook:X86/Portage/CustomTree/fr")[Fonctionnalités avancées](/wiki/Handbook:X86/Portage/Advanced/fr "Handbook:X86/Portage/Advanced/fr")[Configuration du réseau avec OpenRC](/wiki/Handbook:X86/Full/Networking/fr "Handbook:X86/Full/Networking/fr")[Bien démarrer](/wiki/Handbook:X86/Networking/Introduction/fr "Handbook:X86/Networking/Introduction/fr")[Configuration avancée](/wiki/Handbook:X86/Networking/Advanced/fr "Handbook:X86/Networking/Advanced/fr")[Les modules réseau](/wiki/Handbook:X86/Networking/Modular/fr "Handbook:X86/Networking/Modular/fr")[Sans fil](/wiki/Handbook:X86/Networking/Wireless/fr "Handbook:X86/Networking/Wireless/fr")[Ajouter des fonctionnalités](/wiki/Handbook:X86/Networking/Extending/fr "Handbook:X86/Networking/Extending/fr")[Gestion dynamique](/wiki/Handbook:X86/Networking/Dynamic/fr "Handbook:X86/Networking/Dynamic/fr")
...
- [3Micrologiciel](#Micrologiciel)
- [4sys-kernel/installkernel](#sys-kernel.2Finstallkernel)
  - [4.1Programme d’amorçage ( _bootloader_)](#Programme_d.E2.80.99amor.C3.A7age_.28bootloader.29)
    - [4.1.1GRUB](#GRUB)
    - [4.1.2systemd-boot](#systemd-boot)
    - [4.1.3Exécutable noyau EFI ( _EFI stub_)](#Ex.C3.A9cutable_noyau_EFI_.28EFI_stub.29)
    - [4.1.4Choix traditionnel et autres programmes d’amorçage ((e)lilo, syslinux, etc.)](#Choix_traditionnel_et_autres_programmes_d.E2.80.99amor.C3.A7age_.28.28e.29lilo.2C_syslinux.2C_etc..29)
  - [4.2_Initramfs_](#Initramfs)
    - [4.2.1Chroot detection](#Chroot_detection)
  - [4.3Facultatif : image noyau unifiée](#Facultatif_:_image_noyau_unifi.C3.A9e)
    - [4.3.1Image noyau générique unifiée (systemd seulement)](#Image_noyau_g.C3.A9n.C3.A9rique_unifi.C3.A9e_.28systemd_seulement.29)
    - [4.3.2Démarrage sécurisé ( _Secure Boot_)](#D.C3.A9marrage_s.C3.A9curis.C3.A9_.28Secure_Boot.29)
- [5Configuration et compilation du noyau](#Configuration_et_compilation_du_noyau)
  - [5.1Distribution Alternative : utiliser un noyau distribué](#Distribution_Alternative_:_utiliser_un_noyau_distribu.C3.A9)
    - [5.1.1Facultatif : modules de noyau signés](#Facultatif_:_modules_de_noyau_sign.C3.A9s)
    - [5.1.2Facultatif : signer l’image du noyau ( _SecureBoot_)](#Facultatif_:_signer_l.E2.80.99image_du_noyau_.28SecureBoot.29)
    - [5.1.3Installer un noyau distribué](#Installer_un_noyau_distribu.C3.A9)
    - [5.1.4Mettre à jour et nettoyer](#Mettre_.C3.A0_jour_et_nettoyer)
    - [5.1.5Tâches post-installation](#T.C3.A2ches_post-installation)
      - [5.1.5.1Recompiler manuellement un _initramfs_ ou une image unifiée du noyau](#Recompiler_manuellement_un_initramfs_ou_une_image_unifi.C3.A9e_du_noyau)
  - [5.2Approche manuelle](#Approche_manuelle)
  - [5.3Installer les sources du noyau](#Installer_les_sources_du_noyau)
    - [5.3.1Procédure _modprobed-db_](#Proc.C3.A9dure_modprobed-db)
    - [5.3.2Procédure manuelle](#Proc.C3.A9dure_manuelle)
      - [5.3.2.1Activer les options nécessaires](#Activer_les_options_n.C3.A9cessaires)
    - [5.3.3Optionnel : modules noyaux signés](#Optionnel_:_modules_noyaux_sign.C3.A9s)
  - [5.4Compiler et installer](#Compiler_et_installer)
...
Installer certains micrologiciels nécessite souvent d’accepter la licence associée. Si nécessaire, visitez la [section gestion des licences](/wiki/Handbook:X86/Working/Portage/fr#Licenses "Handbook:X86/Working/Portage/fr") du manuel pour de l’aide à propos des licences.
...
Les mises à jour du microcode pour les processeurs AMD sont fournies le paquet susmentionné [sys-kernel/linux-firmware](https://packages.gentoo.org/packages/sys-kernel/linux-firmware). Le microcode pour les processeurs Intel est contenu dans le paquet [sys-firmware/intel-microcode](https://packages.gentoo.org/packages/sys-firmware/intel-microcode), lequel doit être installé séparément. Lisez l’article [microcode](/wiki/Microcode "Microcode") pour plus d’information sur comment mettre à jour un microcode.
...
En utilisant [systemd-boot](/wiki/Systemd/systemd-boot "Systemd/systemd-boot") (anciennement _gummiboot_) comme programme d’amorçage, kernel-install de systemd doit être utilisé. Conséquemment, assurez-vous que les drapeaux [systemd](https://packages.gentoo.org/useflags/systemd) [USE flag/fr](/wiki/USE_flag/fr "USE flag/fr") et [systemd-boot](https://packages.gentoo.org/useflags/systemd-boot) [USE flag/fr](/wiki/USE_flag/fr "USE flag/fr") sont activés pour [sys-kernel/installkernel](https://packages.gentoo.org/packages/sys-kernel/installkernel) ; installez ensuite le paquet adéquat pour systemd-boot.
...
Une image noyau unifiée ( _Unified Kernel Image_, _UKI_) combine, entre autres, le noyau, l’ _initramfs_ et la ligne de commande du noyau dans un seul exécutable. Comme la ligne de commande est embarquée dans une image noyau unifiée, elle doit être spécifiée avant la génération de cette image (voir plus bas). Notez que les arguments ajoutés par le programme d’amorçage ou un microprogramme sont ignorés lors du démarrage en mode démarrage sécurisé ( _secure boot_).
...
[Installkernel](/wiki/Installkernel/fr "Installkernel/fr") peut automatiquement générer une image noyau unifiée en utilisant soit [dracut](/wiki/Unified_kernel_image#dracut.2Ffr "Unified kernel image") ou [ukify](/wiki/Unified_kernel_image#ukify.2Ffr "Unified kernel image") pour activer les drapeaux _USE_ respectifs.
...
Notez que dracut peut générer à la fois une _initramfs_ et une image noyau unifiée, ukify peut seulement générer le 2e et de plus l’ _initramfs_ doit être généré séparément avec dracut.

**Important**

Dans les exemples ci-dessus (pour dracut et ukify), il est important de spécifier au moins un paramètre root= pour la ligne de commandes du noyau et s’assurer que l’image noyau unifiée peut retrouver cette partition racine. Ce n’est pas requis pour les systèmes basés sur systemd suivant les spécifications de partitions découvrables ( _DPS_), dans ce cas, un _initramfs_ embarqué trouvera dynamiquement la partition racine.

#### Image noyau générique unifiée (systemd seulement)

Le paquet pré-compilé [sys-kernel/gentoo-kernel-bin](https://packages.gentoo.org/packages/sys-kernel/gentoo-kernel-bin) peut éventuellement installer une image noyau générique pré-compilée _initramfs_ capable de démarrer la plupart des systèmes basés sur systemd. Il peut être installé en activant le drapeau _USE_ [generic-uki](https://packages.gentoo.org/useflags/generic-uki) [USE flag/fr](/wiki/USE_flag/fr "USE flag/fr") et en configurant [installkernel](/wiki/Installkernel/fr "Installkernel/fr") pour ne pas généré un _initramfs_ personnalisé ou une image noyau unifiée :
...
#### Démarrage sécurisé ( _Secure Boot_)

**Attention !**

Si vous suivez cette section et compilez vous-même votre noyau, assurez-vous d’appliquez les étapes exposées dans [Signer le noyau](/wiki/Kernel#Optional:_Signing_the_kernel_image_.28Secure_Boot.29.2Ffr "Kernel")

L’image noyau générique unifiée peut être distribuée avec [sys-kernel/gentoo-kernel-bin](https://packages.gentoo.org/packages/sys-kernel/gentoo-kernel-bin) qui est déjà pré-signée. Comment signer une image noyau générique unifiée dépend de _dracut_ ou _ukify_ utilisé. Notez que le répertoire de destination de la clé et du certificat devront être le même que les variables SECUREBOOT\_SIGN\_KEY et SECUREBOOT\_SIGN\_CERT tels que spécifié dans /etc/portage/make.conf.
...
##### Facultatif : signer l’image du noyau ( _SecureBoot_)

L’image du noyau distribué ([sys-kernel/gentoo-kernel-bin](https://packages.gentoo.org/packages/sys-kernel/gentoo-kernel-bin)) est précompilé et signée pour un usage avec [Secure Boot](/wiki/Secure_Boot "Secure Boot"). Pour signer l’image noyau des noyaux produits depuis le code source, activer le drapeau [secureboot](https://packages.gentoo.org/useflags/secureboot) [USE flag/fr](/wiki/USE_flag/fr "USE flag/fr") et éventuellement indiquer la clé à utiliser pour signer dans [/etc/portage/make.conf](/wiki//etc/portage/make.conf/fr "/etc/portage/make.conf/fr"). Notez que signer l’image noyau pour _SecureBoot_ nécessite que les modules du noyau soient également signés. La même clé peut être utilisée pour signer à la fois le noyau et ses modules :

FILE **`/etc/portage/make.conf`** **Activer une clé de signature personnalisée**
...
Pour démarrer avec _SecureBoot_ activé, le programme d’amorçage doit également être signé et le certificat accepté par [UEFI](/wiki/UEFI "UEFI") ou [Shim](/wiki/Shim "Shim"). Cela sera expliqué plus tard dans le manuel.
...
Les _[noyaux distribués](/wiki/Project:Distribution_Kernel "Project:Distribution Kernel")_, comme [sys-kernel/gentoo-kernel](https://packages.gentoo.org/packages/sys-kernel/gentoo-kernel) et [sys-kernel/gentoo-kernel-bin](https://packages.gentoo.org/packages/sys-kernel/gentoo-kernel-bin) attendent par défaut d’être installés à côté de [initramfs](/wiki/Handbook:X86/Installation/Kernel#Initramfs.2Ffr "Handbook:X86/Installation/Kernel"). Avant de lancer _emerge_ pour installer le noyau, les utilisateurs doivent s’assurer que [sys-kernel/installkernel](https://packages.gentoo.org/packages/sys-kernel/installkernel) est bien configuré pour utiliser un générateur _initramfs_ (par exemple [Dracut](/wiki/Dracut "Dracut")) comme décrit dans la section [_installkernel_](/wiki/Handbook:X86/Installation/Kernel#Initramfs.2Ffr "Handbook:X86/Installation/Kernel").
...
Après avoir installé le noyau distribué avec succès, il est maintenant possible de continuer dans la prochaine section : [Configurer le système](/wiki/Handbook:X86/Installation/System/fr "Handbook:X86/Installation/System/fr").

### Approche manuelle

### Installer les sources du noyau

Lors de l’installation et la compilation du noyau pour les systèmes basés sur x86, Gentoo recommande le paquet [sys-kernel/gentoo-sources](https://packages.gentoo.org/packages/sys-kernel/gentoo-sources).
...
For now please follow installing [sys-kernel/gentoo-kernel-bin](https://packages.gentoo.org/packages/sys-kernel/gentoo-kernel-bin) via [Distribution\_kernels](/wiki/Handbook:X86/Installation/Kernel#Distribution_kernels.2Ffr "Handbook:X86/Installation/Kernel").
...
Now it's time to decide if modules signing is required in the steps listed in [here](/wiki/Handbook:X86/Installation/Kernel#Optional:_Signed_kernel_modules_2.2Ffr "Handbook:X86/Installation/Kernel")

If not, proceed to building described [here](/wiki/Handbook:X86/Installation/Kernel#Compiling_and_installing.2Ffr "Handbook:X86/Installation/Kernel")
...
{{#switch: x86 \| amd64 \| arm64 \| riscv \| x86 =
...
Continuer l’installation avec [Configurer le système](/wiki/Handbook:X86/Installation/System/fr "Handbook:X86/Installation/System/fr").

[← Installation du système de base](/wiki/Handbook:X86/Installation/Base/fr "Previous part") [Accueil](/wiki/Handbook:X86/fr "Handbook:X86/fr") [Configurer le Système →](/wiki/Handbook:X86/Installation/System/fr "Next part")