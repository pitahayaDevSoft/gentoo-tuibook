...
Wir zeigen für die **x86** Architektur, wie man [GRUB](/wiki/Handbook:X86/Blocks/Bootloader/de#Default:GRUB "Handbook:X86/Blocks/Bootloader/de") für DOS/Legacy-BIOS basierte Systeme und [GRUB](#Standard:_GRUB),
...
Upon successful installation, the output should match the output of the previous command. If the output does not match exactly, then proceed to [Debugging GRUB](/wiki/Handbook:X86/Blocks/Bootloader/de#Debugging_GRUB "Handbook:X86/Blocks/Bootloader/de"), otherwise jump to the [Configure step](/wiki/Handbook:X86/Blocks/Bootloader/de#GRUB_Configure "Handbook:X86/Blocks/Bootloader/de").
...
Nach dem Neustart in die neu installierte Gentoo Umgebung können Sie Ihre Installation mit dem Kapitel [Abschluss der Gentoo Installation](/wiki/Handbook:X86/Installation/Finalizing/de "Handbook:X86/Installation/Finalizing/de") fertigstellen.

[← Installation der Tools](/wiki/Handbook:X86/Installation/Tools/de "Previous part") [Anfang](/wiki/Handbook:X86/de "Handbook:X86/de") [Abschluss der Installation →](/wiki/Handbook:X86/Installation/Finalizing/de "Next part")