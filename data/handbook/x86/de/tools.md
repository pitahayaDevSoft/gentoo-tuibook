...
Als nächstes folgt das Kapitel [Konfigurieren des Bootloaders](/wiki/Handbook:X86/Installation/Bootloader/de "Handbook:X86/Installation/Bootloader/de").

[← Konfiguration des Systems](/wiki/Handbook:X86/Installation/System/de "Previous part") [Anfang](/wiki/Handbook:X86/de "Handbook:X86/de") [Konfiguration des Bootloaders →](/wiki/Handbook:X86/Installation/Bootloader/de "Next part")