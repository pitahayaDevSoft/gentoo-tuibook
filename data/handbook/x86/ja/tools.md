...
次は [ブートローダーの設定](/wiki/Handbook:X86/Installation/Bootloader/ja "Handbook:X86/Installation/Bootloader/ja") です。

[← システムの設定](/wiki/Handbook:X86/Installation/System/ja "Previous part") [Home](/wiki/Handbook:X86/ja "Handbook:X86/ja") [ブートローダーの設定 →](/wiki/Handbook:X86/Installation/Bootloader/ja "Next part")