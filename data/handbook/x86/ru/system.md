...
- [2Информация о сети](#.D0.98.D0.BD.D1.84.D0.BE.D1.80.D0.BC.D0.B0.D1.86.D0.B8.D1.8F_.D0.BE_.D1.81.D0.B5.D1.82.D0.B8)
  ...
  - [2.4Опционально: поддержка PCMCIA-устройств](#.D0.9E.D0.BF.D1.86.D0.B8.D0.BE.D0.BD.D0.B0.D0.BB.D1.8C.D0.BD.D0.BE:_.D0.BF.D0.BE.D0.B4.D0.B4.D0.B5.D1.80.D0.B6.D0.BA.D0.B0_PCMCIA-.D1.83.D1.81.D1.82.D1.80.D0.BE.D0.B9.D1.81.D1.82.D0.B2)
...
Если в качестве системы инициализации используется systemd, UUID разделов соответствуют Discoverable Partition Specification (как это представлено в разделе [Подготовка дисков](/wiki/Handbook:X86/Installation/Disks/ru "Handbook:X86/Installation/Disks/ru")) и система использует UEFI, то создание fstab можно пропустить, так как systemd автоматически монтирует все разделы, соответствующие данной спецификации.
...
В **x86** примере, /boot является обычным /dev/sda1 разделом с рекомендуемой файловой системой xfs. Необходимо проверять его во время загрузки, поэтому мы запишем следующее:
...
Для систем с OpenRC, более подробное руководство по настройке сети доступно в разделе [Расширенная настройка сети](/wiki/Handbook:X86/Networking/Introduction/ru "Handbook:X86/Networking/Introduction/ru"), который находится ближе к концу руководства. Системы с более специфическими сетевыми потребностями могут пропустить этот раздел, а затем вернуться сюда, чтобы продолжить установку.
...
Чтобы установить имя хоста для системы с _уже запущенным_ systemd, можно воспользоваться утилитой hostnamectl. Однако, во время установки вместо неё следует использовать команду [systemd-firstboot](/wiki/Handbook:X86/Installation/System/ru#Init_and_boot_configuration_systemd "Handbook:X86/Installation/System/ru") (см. ниже).
...
Больше информации о настройке сети, в том числе об объединении интерфейсов, создании мостов, настройке 802.1Q VLAN и беспроводной сети, рассматриваются в разделе [Настройка сети](/wiki/Handbook:X86/Networking/Introduction/ru "Handbook:X86/Networking/Introduction/ru").
...
Для систем на **x86**, которым необходима поддержка PCMCIA, необходимо установить пакет [sys-apps/pcmciautils](https://packages.gentoo.org/packages/sys-apps/pcmciautils). Заметьте, что в настоящий момент поддержка этой старой 16-битной технологии [удаляется из основной ветки разработки ядра Linux](https://lore.kernel.org/all/Y07d7rMvd5++85BJ@owl.dominikbrodowski.net/), [начиная с устройств «char»](https://git.kernel.org/pub/scm/linux/kernel/git/gregkh/char-misc.git/commit/?h=char-misc-next&id=9b12f050c76f090cc6d0aebe0ef76fed79ec3f15) в v6.4.0.
...
[← Настройка ядра Linux](/wiki/Handbook:X86/Installation/Kernel/ru "Предыдущая часть") [К содержанию](/wiki/Handbook:X86/ru "Handbook:X86/ru") [Установка системных средств →](/wiki/Handbook:X86/Installation/Tools/ru "Следующая часть")