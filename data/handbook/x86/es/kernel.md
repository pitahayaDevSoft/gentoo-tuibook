...
- [3Configuración y compilación del núcleo](#Configuraci.C3.B3n_y_compilaci.C3.B3n_del_n.C3.BAcleo)
  ...
  - [3.4Compilar e instalar](#Compilar_e_instalar)
...
_[Distribution Kernels](/wiki/Project:Distribution_Kernel "Project:Distribution Kernel")_, such as [sys-kernel/gentoo-kernel](https://packages.gentoo.org/packages/sys-kernel/gentoo-kernel) and [sys-kernel/gentoo-kernel-bin](https://packages.gentoo.org/packages/sys-kernel/gentoo-kernel-bin), by default, expect to be installed alongside an [initramfs](/wiki/Handbook:X86/Installation/Kernel#Initramfs.2Fes "Handbook:X86/Installation/Kernel"). Before running emerge to install the kernel users should ensure that [sys-kernel/installkernel](https://packages.gentoo.org/packages/sys-kernel/installkernel) has been configured to utilize an initramfs generator (for example [Dracut](/wiki/Dracut "Dracut")) as described in the [installkernel section](/wiki/Handbook:X86/Installation/Kernel#Initramfs.2Fes "Handbook:X86/Installation/Kernel").
...
After installing the Distribution Kernel successfully, it is now time to proceed to the next section: [Configuring the system](/wiki/Handbook:X86/Installation/System/es "Handbook:X86/Installation/System/es").

### Alternativa: Configuración manual

### Instalar las fuentes del núcleo

Al instalar y compilar el núcleo para sistemas basados en x86, Gentoo recomienda el paquete [sys-kernel/gentoo-sources](https://packages.gentoo.org/packages/sys-kernel/gentoo-sources).
...
For now please follow installing [sys-kernel/gentoo-kernel-bin](https://packages.gentoo.org/packages/sys-kernel/gentoo-kernel-bin) via [Distribution\_kernels](/wiki/Handbook:X86/Installation/Kernel#Distribution_kernels.2Fes "Handbook:X86/Installation/Kernel").
...
Now it's time to decide if modules signing is required in the steps listed in [here](/wiki/Handbook:X86/Installation/Kernel#Optional:_Signed_kernel_modules_2.2Fes "Handbook:X86/Installation/Kernel")

If not, proceed to building described [here](/wiki/Handbook:X86/Installation/Kernel#Compiling_and_installing.2Fes "Handbook:X86/Installation/Kernel")
...
Continúe la instalación con [Configuring the system](/wiki/Handbook:X86/Installation/System/es "Handbook:X86/Installation/System/es").

[← Instalar el sistema base](/wiki/Handbook:X86/Installation/Base/es "Previous part") [Inicio](/wiki/Handbook:X86/es "Handbook:X86/es") [Configurar el sistema →](/wiki/Handbook:X86/Installation/System/es "Next part")