...
Ahora continúe con [Configurar el cargador de arranque](/wiki/Handbook:X86/Installation/Bootloader/es "Handbook:X86/Installation/Bootloader/es").

[← Configurar el sistema](/wiki/Handbook:X86/Installation/System/es "Previous part") [Inicio](/wiki/Handbook:X86/es "Handbook:X86/es") [Configurar el cargador de arranque →](/wiki/Handbook:X86/Installation/Bootloader/es "Next part")