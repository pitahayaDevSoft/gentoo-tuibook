...
Dla **x86**, udokumentowaliśmy jak skonfigurować zarówno [GRUB2](#Default:_Using_GRUB2) jak i [LILO](#Alternative:_Using_LILO) dla systemów opartych o BIOS, oraz [GRUB2](#Default:_Using_GRUB2) i [efibootmgr](#Alternative:_Using_efibootmgr) dla systemów UEFI.
...
Upon successful installation, the output should match the output of the previous command. If the output does not match exactly, then proceed to [Debugging GRUB](/wiki/Handbook:X86/Blocks/Bootloader/pl#Debugging_GRUB "Handbook:X86/Blocks/Bootloader/pl"), otherwise jump to the [Configure step](/wiki/Handbook:X86/Blocks/Bootloader/pl#GRUB_Configure "Handbook:X86/Blocks/Bootloader/pl").
...
Po uruchomieniu świeżo zainstalowanego środowiska Gentoo, kontynuuj [Finalizowanie instalacji Gentoo](/wiki/Handbook:X86/Installation/Finalizing "Handbook:X86/Installation/Finalizing").

[← Installing tools](/wiki/Handbook:X86/Installation/Tools/pl "Previous part") [Home](/wiki/Handbook:X86 "Handbook:X86") [Finalizing →](/wiki/Handbook:X86/Installation/Finalizing/pl "Next part")