...
Stage 3 files can be downloaded from releases/x86/autobuilds/ on any of the [official Gentoo mirrors](https://www.gentoo.org/downloads/mirrors/). Stages are updated frequently and are therefore not included within official live images.
...
To be able to use sshd, the network needs to function properly. Continue with the chapter on [Configuring the network](/wiki/Handbook:X86/Installation/Networking/pl "Handbook:X86/Installation/Networking/pl").

[← About the installation](/wiki/Handbook:X86/Installation/About "Previous part") [Home](/wiki/Handbook:X86 "Handbook:X86") [Configuring the network →](/wiki/Handbook:X86/Installation/Networking "Next part")