...
- [LVM (Logical Volume Manager)](/wiki/LVM/pl "LVM/pl")
...
Now that the partitions have been created, it is time to place a filesystem on them. In the next section the various file systems that Linux supports are described. Readers that already know which filesystem to use can continue with [Applying a filesystem to a partition](/wiki/Handbook:X86/Installation/Disks/pl#Applying_a_filesystem_to_a_partition "Handbook:X86/Installation/Disks/pl"). The others should read on to learn about the available filesystems...
...
Later in the instructions, the proc filesystem (a virtual interface with the kernel) as well as other kernel pseudo-filesystems will be mounted. But first [the Gentoo stage file](/wiki/Handbook:X86/Installation/Stage/pl "Handbook:X86/Installation/Stage/pl") must be extracted.

[← Configuring the network](/wiki/Handbook:X86/Installation/Networking "Previous part") [Home](/wiki/Handbook:X86 "Handbook:X86") [Installing the stage file →](/wiki/Handbook:X86/Installation/Stage "Next part")