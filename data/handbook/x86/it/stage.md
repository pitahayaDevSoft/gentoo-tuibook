...
Per tutte le immagini live non ufficiali che offrono gpg e wget nell'ambiente live, riferirsi alla sezione antecedente [verificare i file scaricati](/wiki/Handbook:X86/Installation/Media/it#Verifying_the_downloaded_files "Handbook:X86/Installation/Media/it").
...
Ora che il file stage è stato estratto, procedere con la [configurazione delle opzioni di compilazione](/wiki/Handbook:X86/Installation/Stage/it#Configuring_compile_options "Handbook:X86/Installation/Stage/it").
...
[← Preparare i dischi](/wiki/Handbook:X86/Installation/Disks/it "Previous part") [Home](/wiki/Handbook:X86 "Handbook:X86") [Installare il sistema base →](/wiki/Handbook:X86/Installation/Base/it "Next part")