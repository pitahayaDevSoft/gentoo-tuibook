...
A more elaborate set of instructions can be found in [CD/DVD/BD\_writing#Image\_writing](/wiki/CD/DVD/BD_writing#Image_writing.2Ftr "CD/DVD/BD writing").
...
To be able to use sshd, the network needs to function properly. Continue with the chapter on [Configuring the network](/wiki/Handbook:X86/Installation/Networking/tr "Handbook:X86/Installation/Networking/tr").
