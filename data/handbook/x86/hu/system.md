...
- [2Hálózati információk](#H.C3.A1l.C3.B3zati_inform.C3.A1ci.C3.B3k)
  ...
  - [2.4Opcionális: PCMCIA működésének beállítása](#Opcion.C3.A1lis:_PCMCIA_m.C5.B1k.C3.B6d.C3.A9s.C3.A9nek_be.C3.A1ll.C3.ADt.C3.A1sa)
...
A **x86** partíciós példában a /boot általában a /dev/sda1 partíció, a fájlrendszerhez pedig a xfs ajánlott. Ezt ellenőrizni kell az indítás során, így a következőképpen írnánk le:
...
OpenRC-t futtató rendszerek esetében részletesebb hivatkozás a hálózati beállításokhoz a kézikönyv végén található [haladó hálózati beállítás](/wiki/Handbook:X86/Networking/Introduction/hu "Handbook:X86/Networking/Introduction/hu") szakaszban érhető el. Azok a rendszerek, amelyek specifikusabb hálózati igényekkel rendelkeznek, átugorhatják ezt a részt, majd visszatérhetnek ide, hogy folytassák a telepítést.
...
A systemd init-rendszerrel _futó_ operációs rendszer esetében a számítógép nevének a beállítása a hostnamectl segédprogrammal végezhető el. A telepítési folyamat során azonban a [systemd-firstboot](/wiki/Handbook:X86/Installation/System/hu#Init_and_boot_configuration_systemd "Handbook:X86/Installation/System/hu") parancsot kell használni (további részletek később a kézikönyvben).
...
Részletesebb információk a hálózatról, beleértve az olyan haladó témákat, mint a bonding, bridging, 802.1Q VLAN-ok vagy a vezeték nélküli hálózatok, a [haladó hálózati beállítás](/wiki/Handbook:X86/Networking/Introduction/hu "Handbook:X86/Networking/Introduction/hu") szakaszban találhatók.
...
### Opcionális: PCMCIA működésének beállítása

Az **x86** rendszerek, amelyeknek PCMCIA támogatásra van szükségük, telepítsék a [sys-apps/pcmciautils](https://packages.gentoo.org/packages/sys-apps/pcmciautils) csomagot. Fontos megjegyezni, hogy ennek az elavult 16 bites technológiának a támogatása [eltávolításra kerül](https://lore.kernel.org/all/Y07d7rMvd5++85BJ@owl.dominikbrodowski.net/) a Linux kernel főágából [a 'char' eszközök eltávolításával](https://git.kernel.org/pub/scm/linux/kernel/git/gregkh/char-misc.git/commit/?h=char-misc-next&id=9b12f050c76f090cc6d0aebe0ef76fed79ec3f15) a v6.4.0 verziótól kezdődően.
...
[← Kernel beállítása](/wiki/Handbook:X86/Installation/Kernel/hu "Previous part") [Kezdőlap](/wiki/Handbook:X86/hu "Handbook:X86/hu") [Eszközök telepítése →](/wiki/Handbook:X86/Installation/Tools/hu "Next part")