...
For **x86**, we document how to configure [GRUB](/wiki/Handbook:X86/Blocks/Bootloader#Default:_GRUB "Handbook:X86/Blocks/Bootloader") for DOS/Legacy BIOS based systems, and [GRUB](#Default:_GRUB), [systemd-boot](#Alternative_1:_systemd-boot) or [EFI Stub](#Alternative_2:_efibootmgr) for UEFI systems.
...
Upon successful installation, the output should match the output of the previous command. If the output does not match exactly, then proceed to [Debugging GRUB](/wiki/Handbook:X86/Blocks/Bootloader#Debugging_GRUB "Handbook:X86/Blocks/Bootloader"), otherwise jump to the [Configure step](/wiki/Handbook:X86/Blocks/Bootloader#GRUB_Configure "Handbook:X86/Blocks/Bootloader").
...
Once rebooted in the fresh Gentoo environment, continue to the [Finalizing the Gentoo installation](/wiki/Handbook:X86/Installation/Finalizing "Handbook:X86/Installation/Finalizing") for important information on setting up the new installation, and finally some tips on how to start a productive Gentoo Linux journey.

[← Installing tools](/wiki/Handbook:X86/Installation/Tools "Previous part") [Home](/wiki/Handbook:X86 "Handbook:X86") [Finalizing →](/wiki/Handbook:X86/Installation/Finalizing "Next part")