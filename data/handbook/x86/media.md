...
To be able to use sshd, the network needs to function properly. Continue with the chapter on [Configuring the network](/wiki/Handbook:X86/Installation/Networking "Handbook:X86/Installation/Networking").
