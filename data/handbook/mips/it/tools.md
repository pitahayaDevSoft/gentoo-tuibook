...
Ora si prosegua con [Configurare il programma d'avvio](/wiki/Handbook:MIPS/Installation/Bootloader/it "Handbook:MIPS/Installation/Bootloader/it").

[← Configurare il sistema](/wiki/Handbook:MIPS/Installation/System/it "Previous part") [Home](/wiki/Handbook:MIPS "Handbook:MIPS") [Configurare programma d'avvio →](/wiki/Handbook:MIPS/Installation/Bootloader/it "Next part")