...
- [6Usare un CD di installazione](#Usare_un_CD_di_installazione)

## Requisiti hardware

CPU (Big Endian)
CPU di classe MIPS3, MIPS4, MIPS5 o MIPS64
CPU (Little Endian)
CPU di classe MIPS4, MIPS5 o MIPS64
Memoria
128 MB
Spazio sul disco
3.0 GB (escludendo lo spazio di swap)
Spazio di swap
Almeno 256 MB
...
[← Riguardo l'installazione](/wiki/Handbook:MIPS/Installation/About/it "Previous part") [Home](/wiki/Handbook:MIPS/it "Handbook:MIPS/it") [Configurare la rete →](/wiki/Handbook:MIPS/Installation/Networking/it "Next part")