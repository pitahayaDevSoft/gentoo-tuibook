...
- [español](/wiki/Handbook:MIPS/Installation/Tools/es "Manual de Gentoo: MIPS/Instalación/Herramientas (100% translated)")
...
Теперь продолжайте с раздела [Настройка начального загрузчика](/wiki/Handbook:MIPS/Installation/Bootloader/ru "Handbook:MIPS/Installation/Bootloader/ru").

[← Настройка системы](/wiki/Handbook:MIPS/Installation/System/ru "Предыдущая часть") [К содержанию](/wiki/Handbook:MIPS/ru "Handbook:MIPS/ru") [Настройка начального загрузчика →](/wiki/Handbook:MIPS/Installation/Bootloader/ru "Следующая часть")