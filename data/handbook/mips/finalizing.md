...
Readers should definitely take a look at the next part of the handbook entitled [Working with Gentoo](/wiki/Handbook:MIPS/Working/Portage "Handbook:MIPS/Working/Portage") which explains how to keep the software up to date, install additional software packages, details on USE flags, the OpenRC init system, and various other informative topics relating to managing a Gentoo system post-installation.
...
[← Configuring the bootloader](/wiki/Handbook:MIPS/Installation/Bootloader "Previous part") [Home](/wiki/Handbook:MIPS "Handbook:MIPS") [→](/wiki/Handbook:MIPS/Working/Portage "Next part")