...
Als nächstes folgt das Kapitel [Konfigurieren des Bootloaders](/wiki/Handbook:MIPS/Installation/Bootloader/de "Handbook:MIPS/Installation/Bootloader/de").

[← Konfiguration des Systems](/wiki/Handbook:MIPS/Installation/System/de "Previous part") [Anfang](/wiki/Handbook:MIPS/de "Handbook:MIPS/de") [Konfiguration des Bootloaders →](/wiki/Handbook:MIPS/Installation/Bootloader/de "Next part")