...
Bei der in unserem mips Handbuch gewählten Partitionierung ist /boot/ die /dev/sda1 Partition, mit einem xfs Dateisystem. Das Dateisystem soll beim Booten überprüft werden. Es ergibt sich:
...
Für Systeme, auf denen OpenRC läuft, ist eine detailliertere Referenz für die Netzwerkeinrichtung im Abschnitt [Erweiterte Netzwerkkonfiguration](/wiki/Handbook:MIPS/Networking/Introduction/de "Handbook:MIPS/Networking/Introduction/de") verfügbar, der gegen Ende des Handbuchs behandelt wird. Systeme mit spezielleren Netzwerkanforderungen müssen eventuell den Abschnitt überspringen und dann hierher zurückkehren, um mit dem Rest der Installation fortzufahren.
...
Weitere Informationen über Netzwerke, insbesondere auch über fortgeschrittene Themen wie Bonding, Bridges, 802.1Q VLANs oder WLAN, finden Sie in dem Abschnitt [Fortgeschrittene Netzwerk-Konfiguration](/wiki/Handbook:MIPS/Networking/Introduction/de "Handbook:MIPS/Networking/Introduction/de").
...
[← Konfiguration des Kernels](/wiki/Handbook:MIPS/Installation/Kernel/de "Previous part") [Anfang](/wiki/Handbook:MIPS/de "Handbook:MIPS/de") [Installation der Tools →](/wiki/Handbook:MIPS/Installation/Tools/de "Next part")