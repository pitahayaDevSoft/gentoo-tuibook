...
Now continue with [Configuring the bootloader](/wiki/Handbook:MIPS/Installation/Bootloader/pl "Handbook:MIPS/Installation/Bootloader/pl").

[← Configuring the system](/wiki/Handbook:MIPS/Installation/System "Previous part") [Home](/wiki/Handbook:MIPS "Handbook:MIPS") [Configuring the bootloader →](/wiki/Handbook:MIPS/Installation/Bootloader "Next part")