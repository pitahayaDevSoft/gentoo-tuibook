...
Definitivamente los lectores deben echar un vistazo a la siguiente parte del manual de Gentoo titulado [Trabajando con Gentoo](/wiki/Handbook:MIPS/Working/Portage/es "Handbook:MIPS/Working/Portage/es") que explica como mantener el software actualizado, instalar paquetes adicionales de software, detalles sobre los ajustes USE, el sistema de inicio OpenRC y algunos otros elementos informativos relacionados con la gestión de un sistema Gentoo después de su instalación.
...
[← Configurar el cargador de arranque](/wiki/Handbook:MIPS/Installation/Bootloader/es "Previous part") [Inicio](/wiki/Handbook:MIPS/es "Handbook:MIPS/es") [→](/wiki/Handbook:MIPS/Working/Portage/es "Next part")