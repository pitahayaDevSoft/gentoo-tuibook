...
For systems running OpenRC, a more detailed reference for network setup is available in the [advanced network configuration](/wiki/Handbook:MIPS/Networking/Introduction/ko "Handbook:MIPS/Networking/Introduction/ko") section, which is covered near the end of the handbook. Systems with more specific network needs may need to skip ahead, then return here to continue with the rest of the installation.
...
[← 리눅스 커널 설정](/wiki/Handbook:MIPS/Installation/Kernel/ko "이전 내용") [처음](/wiki/Handbook:MIPS/ko "Handbook:MIPS/ko") [시스템 도구 설치 →](/wiki/Handbook:MIPS/Installation/Tools/ko "다음 내용")