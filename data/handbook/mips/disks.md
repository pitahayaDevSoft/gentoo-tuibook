...
### Partitions\[ [edit](/index.php?title=Handbook:MIPS/Blocks/Disks&action=edit&section=T-1 "Edit section: ")\]
...
## Using fdisk\[ [edit](/index.php?title=Handbook:MIPS/Blocks/Disks&action=edit&section=T-2 "Edit section: ")\]

### SGI machines: Creating an SGI disk label\[ [edit](/index.php?title=Handbook:MIPS/Blocks/Disks&action=edit&section=T-3 "Edit section: ")\]
...
### Resizing the SGI volume header\[ [edit](/index.php?title=Handbook:MIPS/Blocks/Disks&action=edit&section=T-4 "Edit section: ")\]
...
### Partitioning Cobalt drives\[ [edit](/index.php?title=Handbook:MIPS/Blocks/Disks&action=edit&section=T-5 "Edit section: ")\]
...
Later in the instructions, the proc filesystem (a virtual interface with the kernel) as well as other kernel pseudo-filesystems will be mounted. But first [the Gentoo stage file](/wiki/Handbook:MIPS/Installation/Stage "Handbook:MIPS/Installation/Stage") must be extracted.
