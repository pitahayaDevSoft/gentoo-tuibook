...
Miután a stage fájl letöltése befejeződött, lehetőség van a stage fájl integritásának ellenőrzésére és tartalmának érvényesítésére. Az eziránt érdeklődők az olvasást folytassák a [következő szakaszban](/wiki/Handbook:MIPS/Installation/Stage/hu#Verifying_and_validating "Handbook:MIPS/Installation/Stage/hu").

Azok, akik nem szeretnék ellenőrizni és érvényesíteni a stage fájlt, kiléphetnek a parancssoros böngészőből a `q` billentyűgomb megnyomásával, és közvetlenül áttérhetnek az [Stage fájl telepítése](/wiki/Handbook:MIPS/Installation/Stage/hu#Unpacking_the_stage_tarball "Handbook:MIPS/Installation/Stage/hu") szakaszra.
...
Most, hogy a stage fájl ki lett csomagolva, folytassa a [kódfordítási beállításoknak a szerkesztésével](/wiki/Handbook:MIPS/Installation/Stage/hu#Configuring_compile_options "Handbook:MIPS/Installation/Stage/hu").
...
[← Adathordozók előkészítése](/wiki/Handbook:MIPS/Installation/Disks/hu "Previous part") [Kezdőlap](/wiki/Handbook:MIPS/hu "Handbook:MIPS/hu") [Alaprendszer telepítése →](/wiki/Handbook:MIPS/Installation/Base/hu "Next part")