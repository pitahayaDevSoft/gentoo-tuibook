...
Most folytassa a [Bootloader beállítása](/wiki/Handbook:MIPS/Installation/Bootloader/hu "Handbook:MIPS/Installation/Bootloader/hu") részével.

[← Rendszer beállítása](/wiki/Handbook:MIPS/Installation/System/hu "Previous part") [Kezdőlap](/wiki/Handbook:MIPS/hu "Handbook:MIPS/hu") [Bootloader beállítása →](/wiki/Handbook:MIPS/Installation/Bootloader/hu "Next part")