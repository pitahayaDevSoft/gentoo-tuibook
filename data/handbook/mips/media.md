...
For more information, read [MIPS Hardware Requirements](/wiki/MIPS/Hardware_Requirements "MIPS/Hardware Requirements").

## Installation notes\[ [edit](/index.php?title=Handbook:MIPS/Blocks/HWReqs&action=edit&section=T-1 "Edit section: ")\]
...
MIPS32
32-bit
AMD Alchemy series, 4kc, 4km, many others... There are a few revisions in the MIPS32 ISA.
MIPS64
64-bit
Broadcom SiByte SB1, 5kc ... etc... There are a few revisions in the MIPS64 ISA.
...
## Netbooting overview\[ [edit](/index.php?title=Handbook:MIPS/Blocks/HWReqs&action=edit&section=T-2 "Edit section: ")\]

In this section, we'll cover what is needed to successfully network boot a Silicon Graphics workstation or Cobalt Server appliance. This is just a brief guide, it is not intended to be thorough, for more information, it is recommended to read the [Diskless nodes](/wiki/Diskless_nodes "Diskless nodes") article.
...
### Setting up TFTP and DHCP\[ [edit](/index.php?title=Handbook:MIPS/Blocks/HWReqs&action=edit&section=T-3 "Edit section: ")\]
...
FILE **`/etc/dhcp/dhcpd.conf`** **Bare Bones dhcpd.conf**
...
## Netbooting on SGI stations\[ [edit](/index.php?title=Handbook:MIPS/Blocks/HWReqs&action=edit&section=T-4 "Edit section: ")\]

### Downloading a netboot image\[ [edit](/index.php?title=Handbook:MIPS/Blocks/HWReqs&action=edit&section=T-5 "Edit section: ")\]
...
_Indigo 2_ \- It is a common mistake to mix up the IRIS Indigo (IP12 w/ R3000 CPU or IP20 with a R4000 CPU, neither of which run Linux), the Indigo 2 (IP22, which runs Linux fine), the R8000-based Indigo 2 Power (which doesn't run Linux at all) and the R10000-based Indigo 2 Impact (IP28, which is highly experimental). Please bear in mind that these are different machines.

Also in the filename, r4k refers to R4000-series processors, r5k for R5000, rm5k for the RM5200 and r10k for R10000. The images are available on the [Gentoo mirrors](https://www.gentoo.org/downloads/mirrors/).

### DHCP configuration for an SGI client\[ [edit](/index.php?title=Handbook:MIPS/Blocks/HWReqs&action=edit&section=T-6 "Edit section: ")\]
...
FILE **`/etc/dhcp/dhcpd.conf`** **snippet for SGI Workstation**
...
### Kernel options\[ [edit](/index.php?title=Handbook:MIPS/Blocks/HWReqs&action=edit&section=T-7 "Edit section: ")\]
...
### Starting the daemons\[ [edit](/index.php?title=Handbook:MIPS/Blocks/HWReqs&action=edit&section=T-8 "Edit section: ")\]
...
### Netbooting the SGI station\[ [edit](/index.php?title=Handbook:MIPS/Blocks/HWReqs&action=edit&section=T-9 "Edit section: ")\]
...
### Troubleshooting\[ [edit](/index.php?title=Handbook:MIPS/Blocks/HWReqs&action=edit&section=T-10 "Edit section: ")\]
...
## Netbooting on Cobalt stations\[ [edit](/index.php?title=Handbook:MIPS/Blocks/HWReqs&action=edit&section=T-11 "Edit section: ")\]

### Overview of the netboot procedure\[ [edit](/index.php?title=Handbook:MIPS/Blocks/HWReqs&action=edit&section=T-12 "Edit section: ")\]

Unlike the SGI machines, Cobalt servers use NFS to transfer their kernel for booting. Boot the machine by holding down the left & right arrow buttons whilst powering the unit on. The machine will then attempt to obtain an IP number via BOOTP, mount the /nfsroot/ directory from the server via NFS, then try to download and boot the file vmlinux\_raq-2800.gz (depending on the model) which it assumes to be a standard ELF binary.

### Downloading a Cobalt netboot image\[ [edit](/index.php?title=Handbook:MIPS/Blocks/HWReqs&action=edit&section=T-13 "Edit section: ")\]

Inside [http://distfiles.gentoo.org/experimental/mips/historical/netboot/cobalt/](http://distfiles.gentoo.org/experimental/mips/historical/netboot/cobalt/) the necessary boot images for getting a Cobalt up and running are made available. The files will have the name nfsroot-KERNEL-COLO-DATE-cobalt.tar - select the most recent one and unpack it to / as shown below:

`root #` `tar -C / -xvf nfsroot-2.6.13.4-1.19-20051122-cobalt.tar`

### NFS server configuration\[ [edit](/index.php?title=Handbook:MIPS/Blocks/HWReqs&action=edit&section=T-14 "Edit section: ")\]

Since this machine uses NFS to download its image, it is necessary to export /nfsroot/ on the server. Install the [net-fs/nfs-utils](https://packages.gentoo.org/packages/net-fs/nfs-utils) package:
...
### DHCP configuration for a Cobalt machine\[ [edit](/index.php?title=Handbook:MIPS/Blocks/HWReqs&action=edit&section=T-15 "Edit section: ")\]

Now, the DHCP side of things is relatively straightforward. Add the following to the /etc/dhcp/dhcpd.conf file.

FILE **`/etc/dhcp/dhcpd.conf`** **Snippet for Cobalt server**
...
### Starting daemons\[ [edit](/index.php?title=Handbook:MIPS/Blocks/HWReqs&action=edit&section=T-16 "Edit section: ")\]
...
### Netbooting the Cobalt machine\[ [edit](/index.php?title=Handbook:MIPS/Blocks/HWReqs&action=edit&section=T-17 "Edit section: ")\]
...
### Troubleshooting\[ [edit](/index.php?title=Handbook:MIPS/Blocks/HWReqs&action=edit&section=T-18 "Edit section: ")\]
...
## Using an installation CD\[ [edit](/index.php?title=Handbook:MIPS/Installation/Media&action=edit&section=2 "Edit section: Using an installation CD")\]
...
These CDs are highly experimental at this time. They may or may not work at this time. Please report success or failures either on Bugzilla, [this forum thread](https://forums.gentoo.org/viewtopic.php?t=242518) or in the #gentoo-mips IRC channel.

[← About the installation](/wiki/Handbook:MIPS/Installation/About "Previous part") [Home](/wiki/Handbook:MIPS "Handbook:MIPS") [Configuring the network →](/wiki/Handbook:MIPS/Installation/Networking "Next part")