...
次は [ブートローダーの設定](/wiki/Handbook:MIPS/Installation/Bootloader/ja "Handbook:MIPS/Installation/Bootloader/ja") です。

[← システムの設定](/wiki/Handbook:MIPS/Installation/System/ja "Previous part") [Home](/wiki/Handbook:MIPS/ja "Handbook:MIPS/ja") [ブートローダーの設定 →](/wiki/Handbook:MIPS/Installation/Bootloader/ja "Next part")