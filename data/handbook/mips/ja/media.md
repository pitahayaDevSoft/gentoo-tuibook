...
- [6インストール CD を用いる](#.E3.82.A4.E3.83.B3.E3.82.B9.E3.83.88.E3.83.BC.E3.83.AB_CD_.E3.82.92.E7.94.A8.E3.81.84.E3.82.8B)
...
ファイル **`/etc/dhcp/dhcpd.conf`** **Bare Bones dhcpd.conf**
...
ファイル **`/etc/dhcp/dhcpd.conf`** **snippet for SGI Workstation**
...
コード **When things are going right...**
...
ファイル **`/etc/exports`** **Exporting the /nfsroot directory**
...
ファイル **`/etc/dhcp/dhcpd.conf`** **Snippet for Cobalt server**
...
[← Gentoo Linux のインストールについて](/wiki/Handbook:MIPS/Installation/About/ja "Previous part") [Home](/wiki/Handbook:MIPS/ja "Handbook:MIPS/ja") [ネットワーク設定 →](/wiki/Handbook:MIPS/Installation/Networking/ja "Next part")